...
"""
Generate KiCad 8 schematic.

The graphical work -- placement, routing, writing the .kicad_sch files -- is
done by the separate ``schematizer`` package. This module is the KiCad 8
...
# output format details for this version (KiCad 8 differs slightly from its
# neighbors in how symbol pin numbers and fonts are written).
TOOL_NAME = "kicad8"
...
def gen_sch(circuit, **kwargs):
    """
    Generate KiCad 8 schematic files for a circuit.
