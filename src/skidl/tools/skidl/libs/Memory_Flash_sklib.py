...
Memory_Flash = SchLib(tool=SKIDL).add_parts(*[
        ...
        Part(**{ 'name':'AM29F400Bx-xxEx', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'AM29F400Bx-xxEx'}), 'ref_prefix':'U', 'fplist':['Package_SO:TSOP-I-48_18.4x12mm_P0.5mm'], 'footprint':'Package_SO:TSOP-I-48_18.4x12mm_P0.5mm', 'keywords':'FLASH 4Mbit', 'description':'', 'datasheet':'https://www.mouser.com/datasheet/2/380/AM29F400B_EOL_21505e8-9219.pdf', 'search_text':'/usr/share/kicad/symbols/Memory_Flash.kicad_sym\nAM29F400Bx-xxEx\n\nFLASH 4Mbit', 'pins':[
            ...
            Pin(num='15',name='RY/~{BY}',func=Pin.types.OPENCOLL,unit=1),
            ...
            Pin(num='29',name='DQ0',func=Pin.types.TRISTATE,unit=1),
            Pin(num='3',name='A13',func=Pin.types.INPUT,unit=1),
            Pin(num='30',name='DQ8',func=Pin.types.TRISTATE,unit=1),
            Pin(num='31',name='DQ1',func=Pin.types.TRISTATE,unit=1),
            Pin(num='32',name='DQ9',func=Pin.types.TRISTATE,unit=1),
            Pin(num='33',name='DQ2',func=Pin.types.TRISTATE,unit=1),
            Pin(num='34',name='DQ10',func=Pin.types.TRISTATE,unit=1),
            Pin(num='35',name='DQ3',func=Pin.types.TRISTATE,unit=1),
            Pin(num='36',name='DQ11',func=Pin.types.TRISTATE,unit=1),
            Pin(num='37',name='VCC',func=Pin.types.PWRIN,unit=1),
            Pin(num='38',name='DQ4',func=Pin.types.TRISTATE,unit=1),
            Pin(num='39',name='DQ12',func=Pin.types.TRISTATE,unit=1),
            Pin(num='4',name='A12',func=Pin.types.INPUT,unit=1),
            Pin(num='40',name='DQ5',func=Pin.types.TRISTATE,unit=1),
            Pin(num='41',name='DQ13',func=Pin.types.TRISTATE,unit=1),
            Pin(num='42',name='DQ6',func=Pin.types.TRISTATE,unit=1),
            Pin(num='43',name='DQ14',func=Pin.types.TRISTATE,unit=1),
            Pin(num='44',name='DQ7',func=Pin.types.TRISTATE,unit=1),
            Pin(num='45',name='DQ15/A-1',func=Pin.types.TRISTATE,unit=1),
            Pin(num='46',name='VSS',func=Pin.types.PASSIVE,unit=1),
            Pin(num='47',name='~{BYTE}',func=Pin.types.INPUT,unit=1),
        ...
        Part(**{ 'name':'AM29F400Bx-xxSx', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'AM29F400Bx-xxSx'}), 'ref_prefix':'U', 'fplist':['Package_SO:SOP-44_13.3x28.2mm_P1.27mm'], 'footprint':'Package_SO:SOP-44_13.3x28.2mm_P1.27mm', 'keywords':'FLASH 4Mbit', 'description':'', 'datasheet':'https://www.mouser.com/datasheet/2/380/AM29F400B_EOL_21505e8-9219.pdf', 'search_text':'/usr/share/kicad/symbols/Memory_Flash.kicad_sym\nAM29F400Bx-xxSx\n\nFLASH 4Mbit', 'pins':[
            ...
            Pin(num='14',name='~{OE}',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='DQ0',func=Pin.types.TRISTATE,unit=1),
            Pin(num='16',name='DQ8',func=Pin.types.TRISTATE,unit=1),
            Pin(num='17',name='DQ1',func=Pin.types.TRISTATE,unit=1),
            Pin(num='18',name='DQ9',func=Pin.types.TRISTATE,unit=1),
            Pin(num='19',name='DQ2',func=Pin.types.TRISTATE,unit=1),
            Pin(num='2',name='RY/~{BY}',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='20',name='DQ10',func=Pin.types.TRISTATE,unit=1),
            Pin(num='21',name='DQ3',func=Pin.types.TRISTATE,unit=1),
            Pin(num='22',name='DQ11',func=Pin.types.TRISTATE,unit=1),
            Pin(num='23',name='VCC',func=Pin.types.PWRIN,unit=1),
            Pin(num='24',name='DQ4',func=Pin.types.TRISTATE,unit=1),
            Pin(num='25',name='DQ12',func=Pin.types.TRISTATE,unit=1),
            Pin(num='26',name='DQ5',func=Pin.types.TRISTATE,unit=1),
            Pin(num='27',name='DQ13',func=Pin.types.TRISTATE,unit=1),
            Pin(num='28',name='DQ6',func=Pin.types.TRISTATE,unit=1),
            Pin(num='29',name='DQ14',func=Pin.types.TRISTATE,unit=1),
            Pin(num='3',name='A17',func=Pin.types.INPUT,unit=1),
            Pin(num='30',name='DQ7',func=Pin.types.TRISTATE,unit=1),
            Pin(num='31',name='DQ15/A-1',func=Pin.types.TRISTATE,unit=1),
