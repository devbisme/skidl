...
Memory_UniqueID = SchLib(tool=SKIDL).add_parts(*[
        Part(**{ 'name':'DS2401P', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DS2401P'}), 'ref_prefix':'U', 'fplist':['Package_SO_J-Lead:TSOC-6_3.76x3.94mm_P1.27mm'], 'footprint':'Package_SO_J-Lead:TSOC-6_3.76x3.94mm_P1.27mm', 'keywords':'OneWire 1-Wire 1Wire Maxim Dallas ID', 'description':'', 'datasheet':'http://pdfserv.maximintegrated.com/en/ds/DS2401.pdf', 'pins':[
        ...
        Part(**{ 'name':'DS2401Z', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DS2401Z'}), 'ref_prefix':'U', 'fplist':['Package_TO_SOT_SMD:SOT-223'], 'footprint':'Package_TO_SOT_SMD:SOT-223', 'keywords':'OneWire 1-Wire 1Wire Maxim Dallas ID', 'description':'', 'datasheet':'http://pdfserv.maximintegrated.com/en/ds/DS2401.pdf', 'pins':[
