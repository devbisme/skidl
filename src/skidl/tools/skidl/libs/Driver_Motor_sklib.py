...
Driver_Motor = SchLib(tool=SKIDL).add_parts(*[
        Part(**{ 'name':'A4950E', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'A4950E'}), 'ref_prefix':'U', 'fplist':['Package_SO:SOIC-8-1EP_3.9x4.9mm_P1.27mm_EP2.41x3.3mm'], 'footprint':'Package_SO:SOIC-8-1EP_3.9x4.9mm_P1.27mm_EP2.41x3.3mm', 'keywords':'full-bridge h-bridge', 'description':'', 'datasheet':'http://www.allegromicro.com/~/media/Files/Datasheets/A4950-Datasheet.ashx', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nA4950E\n\nfull-bridge h-bridge', 'pins':[
            ...
            Pin(num='6',name='OUT1',func=Pin.types.PWROUT,unit=1),
        ...
        Part(**{ 'name':'A4952_LY', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'A4952_LY'}), 'ref_prefix':'U', 'fplist':['Package_SO:MSOP-10-1EP_3x3mm_P0.5mm_EP1.73x1.98mm'], 'footprint':'Package_SO:MSOP-10-1EP_3x3mm_P0.5mm_EP1.73x1.98mm', 'keywords':'Full-bridge h-bridge', 'description':'', 'datasheet':'www.allegromicro.com/~/media/Files/Datasheets/A4952-3-Datasheet.ashx?la=en', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nA4952_LY\n\nFull-bridge h-bridge', 'pins':[
            ...
            Pin(num='2',name='RTRY',func=Pin.types.INPUT,unit=1),
        ...
        Part(**{ 'name':'A4954', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'A4954'}), 'ref_prefix':'U', 'fplist':['Package_SO:TSSOP-16-1EP_4.4x5mm_P0.65mm_EP3x3mm'], 'footprint':'Package_SO:TSSOP-16-1EP_4.4x5mm_P0.65mm_EP3x3mm', 'keywords':'Fullbridge, Stepper Driver', 'description':'', 'datasheet':'https://www.allegromicro.com/-/media/Files/Datasheets/A4954-Datasheet.ashx', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nA4954\n\nFullbridge, Stepper Driver', 'pins':[
            ...
            Pin(num='12',name='OUT2',func=Pin.types.PWROUT,unit=1),
            Pin(num='13',name='OUT3',func=Pin.types.PWROUT,unit=1),
            Pin(num='14',name='LSS34',func=Pin.types.PWRIN,unit=1),
            Pin(num='15',name='OUT4',func=Pin.types.PWROUT,unit=1),
            Pin(num='16',name='VBB',func=Pin.types.PASSIVE,unit=1),
            Pin(num='17',name='GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='2',name='VREF34',func=Pin.types.INPUT,unit=1),
            ...
            Pin(num='6',name='IN1',func=Pin.types.INPUT,unit=1),
        ...
        Part(**{ 'name':'AMT49413', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'AMT49413'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:QFN-48-1EP_7x7mm_P0.5mm_EP5.15x5.15mm_ThermalVias'], 'footprint':'Package_DFN_QFN:QFN-48-1EP_7x7mm_P0.5mm_EP5.15x5.15mm_ThermalVias', 'keywords':'BLDC 3-Phase', 'description':'', 'datasheet':'https://www.allegromicro.com/-/media/Files/Datasheets/AMT49413-Datasheet.ashx', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nAMT49413\n\nBLDC 3-Phase', 'pins':[
            ...
            Pin(num='12',name='H3',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='N.C.',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='14',name='PWM',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='MODE',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='RC',func=Pin.types.PASSIVE,unit=1),
            Pin(num='17',name='TEST',func=Pin.types.INPUT,unit=1),
            Pin(num='18',name='RDEAD',func=Pin.types.PASSIVE,unit=1),
            Pin(num='19',name='CSOUT',func=Pin.types.INPUT,unit=1),
            Pin(num='2',name='~{RESET}',func=Pin.types.INPUT,unit=1),
            Pin(num='20',name='REF',func=Pin.types.INPUT,unit=1),
            Pin(num='21',name='CSN',func=Pin.types.INPUT,unit=1),
            Pin(num='22',name='CSP',func=Pin.types.INPUT,unit=1),
            Pin(num='23',name='VDSTH',func=Pin.types.INPUT,unit=1),
            Pin(num='24',name='VDRAIN',func=Pin.types.PWRIN,unit=1),
            Pin(num='25',name='SC',func=Pin.types.INPUT,unit=1),
            Pin(num='26',name='GHC',func=Pin.types.OUTPUT,unit=1),
            Pin(num='27',name='CC',func=Pin.types.PASSIVE,unit=1),
            Pin(num='28',name='SB',func=Pin.types.INPUT,unit=1),
            Pin(num='29',name='GHB',func=Pin.types.OUTPUT,unit=1),
            Pin(num='3',name='V5DB',func=Pin.types.PWROUT,unit=1),
            Pin(num='30',name='CB',func=Pin.types.PASSIVE,unit=1),
            Pin(num='31',name='SA',func=Pin.types.INPUT,unit=1),
            Pin(num='32',name='GHA',func=Pin.types.OUTPUT,unit=1),
            Pin(num='33',name='CA',func=Pin.types.PASSIVE,unit=1),
            Pin(num='34',name='GLC',func=Pin.types.OUTPUT,unit=1),
            Pin(num='35',name='GLB',func=Pin.types.OUTPUT,unit=1),
            Pin(num='36',name='GLA',func=Pin.types.OUTPUT,unit=1),
            Pin(num='37',name='N.C.',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='38',name='LSS',func=Pin.types.INPUT,unit=1),
            Pin(num='39',name='ESF',func=Pin.types.INPUT,unit=1),
            Pin(num='4',name='V5',func=Pin.types.PWROUT,unit=1),
            Pin(num='40',name='VREG',func=Pin.types.PWROUT,unit=1),
            Pin(num='41',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='42',name='CP1',func=Pin.types.PASSIVE,unit=1),
            Pin(num='43',name='CP2',func=Pin.types.PASSIVE,unit=1),
            Pin(num='44',name='DIRO',func=Pin.types.OUTPUT,unit=1),
            Pin(num='45',name='VBB',func=Pin.types.PWRIN,unit=1),
            Pin(num='46',name='COAST',func=Pin.types.INPUT,unit=1),
            Pin(num='47',name='N.C.',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='48',name='N.C.',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='49',name='GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='5',name='FF2',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='6',name='FF1',func=Pin.types.OPENCOLL,unit=1),
        ...
        Part(**{ 'name':'DRV8308', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DRV8308'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:Texas_RHA0040E_VQFN-40-1EP_6x6mm_P0.5mm_EP3.52x2.62mm'], 'footprint':'Package_DFN_QFN:Texas_RHA0040E_VQFN-40-1EP_6x6mm_P0.5mm_EP3.52x2.62mm', 'keywords':'bldc mosfet-driver hall-sensor', 'description':'', 'datasheet':'http://www.ti.com/lit/ds/symlink/drv8308.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nDRV8308\n\nbldc mosfet-driver hall-sensor', 'pins':[
            ...
            Pin(num='12',name='SCS',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='SMODE',func=Pin.types.INPUT,unit=1),
            Pin(num='14',name='SDATAI',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='SDATAO',func=Pin.types.OUTPUT,unit=1),
            Pin(num='16',name='FGOUT',func=Pin.types.OUTPUT,unit=1),
            Pin(num='17',name='~{FAULTn}',func=Pin.types.OUTPUT,unit=1),
            Pin(num='18',name='~{LOCKn}',func=Pin.types.OUTPUT,unit=1),
            Pin(num='19',name='CLKIN',func=Pin.types.INPUT,unit=1),
            Pin(num='2',name='UHN',func=Pin.types.INPUT,unit=1),
            Pin(num='20',name='BRAKE',func=Pin.types.INPUT,unit=1),
            Pin(num='21',name='DIR',func=Pin.types.INPUT,unit=1),
            Pin(num='22',name='ENABLE',func=Pin.types.INPUT,unit=1),
            Pin(num='23',name='RESET',func=Pin.types.INPUT,unit=1),
            Pin(num='24',name='VREG',func=Pin.types.PWROUT,unit=1),
            Pin(num='25',name='VINT',func=Pin.types.PASSIVE,unit=1),
            Pin(num='26',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='27',name='VM',func=Pin.types.PWRIN,unit=1),
            Pin(num='28',name='VCP',func=Pin.types.PASSIVE,unit=1),
            Pin(num='29',name='CP2',func=Pin.types.PASSIVE,unit=1),
            Pin(num='3',name='VHP',func=Pin.types.INPUT,unit=1),
            Pin(num='30',name='CP1',func=Pin.types.PASSIVE,unit=1),
            Pin(num='31',name='ISEN',func=Pin.types.INPUT,unit=1),
            Pin(num='32',name='UHSG',func=Pin.types.OUTPUT,unit=1),
            Pin(num='33',name='U',func=Pin.types.INPUT,unit=1),
            Pin(num='34',name='ULSG',func=Pin.types.OUTPUT,unit=1),
            Pin(num='35',name='VHSG',func=Pin.types.OUTPUT,unit=1),
            Pin(num='36',name='V',func=Pin.types.INPUT,unit=1),
            Pin(num='37',name='VLSG',func=Pin.types.OUTPUT,unit=1),
            Pin(num='38',name='WHSG',func=Pin.types.OUTPUT,unit=1),
            Pin(num='39',name='W',func=Pin.types.INPUT,unit=1),
            Pin(num='4',name='VHN',func=Pin.types.INPUT,unit=1),
            Pin(num='40',name='WLSG',func=Pin.types.OUTPUT,unit=1),
            Pin(num='41',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='5',name='WHP',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='WHN',func=Pin.types.INPUT,unit=1),
        ...
        Part(**{ 'name':'DRV8412', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DRV8412'}), 'ref_prefix':'U', 'fplist':['Package_SO:HTSSOP-44-1EP_6.1x14mm_P0.635mm_EP5.2x14mm_Mask4.31x8.26mm_ThermalVias'], 'footprint':'Package_SO:HTSSOP-44-1EP_6.1x14mm_P0.635mm_EP5.2x14mm_Mask4.31x8.26mm_ThermalVias', 'keywords':'Dual Full-Bridge PWM Motor Driver', 'description':'', 'datasheet':'https://www.ti.com/lit/gpn/DRV8412', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nDRV8412\n\nDual Full-Bridge PWM Motor Driver', 'pins':[
            ...
            Pin(num='14',name='OC_ADJ',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='PWM_B',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='~{RESET_AB}',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='PWM_A',func=Pin.types.INPUT,unit=1),
            Pin(num='18',name='~{FAULT}',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='19',name='NC/GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='2',name='VDD',func=Pin.types.PWRIN,unit=1),
            Pin(num='20',name='NC/GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='21',name='~{OTW}',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='22',name='GVDD_B',func=Pin.types.PWRIN,unit=1),
            Pin(num='23',name='GVDD_A',func=Pin.types.PWRIN,unit=1),
            Pin(num='24',name='BST_A',func=Pin.types.INPUT,unit=1),
            Pin(num='25',name='NC/GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='26',name='PVDD_A',func=Pin.types.PWRIN,unit=1),
            Pin(num='27',name='PVDD_A',func=Pin.types.PWRIN,unit=1),
            Pin(num='28',name='OUT_A',func=Pin.types.OUTPUT,unit=1),
            Pin(num='29',name='GND_A',func=Pin.types.PWRIN,unit=1),
            Pin(num='3',name='NC/GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='30',name='GND_B',func=Pin.types.PWRIN,unit=1),
            Pin(num='31',name='OUT_B',func=Pin.types.OUTPUT,unit=1),
            Pin(num='32',name='PVDD_B',func=Pin.types.PWRIN,unit=1),
            Pin(num='33',name='BST_B',func=Pin.types.INPUT,unit=1),
            Pin(num='34',name='BST_C',func=Pin.types.INPUT,unit=1),
            Pin(num='35',name='PVDD_C',func=Pin.types.PWRIN,unit=1),
            Pin(num='36',name='OUT_C',func=Pin.types.OUTPUT,unit=1),
            Pin(num='37',name='GND_C',func=Pin.types.PWRIN,unit=1),
            Pin(num='38',name='GND_D',func=Pin.types.PWRIN,unit=1),
            Pin(num='39',name='OUT_D',func=Pin.types.OUTPUT,unit=1),
            Pin(num='4',name='NC/GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='40',name='PVDD_D',func=Pin.types.PWRIN,unit=1),
            Pin(num='41',name='PVDD_D',func=Pin.types.PWRIN,unit=1),
            Pin(num='42',name='NC/GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='43',name='BST_D',func=Pin.types.INPUT,unit=1),
            Pin(num='44',name='GVDD_D',func=Pin.types.PWRIN,unit=1),
            Pin(num='45',name='EP',func=Pin.types.PWRIN,unit=1),
            Pin(num='5',name='PWM_D',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='~{RESET_CD}',func=Pin.types.INPUT,unit=1),
        ...
        Part(**{ 'name':'DRV8432', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DRV8432'}), 'ref_prefix':'U', 'fplist':['Package_SO:HSOP-36-1EP_11.0x15.9mm_P0.65mm_SlugUp'], 'footprint':'Package_SO:HSOP-36-1EP_11.0x15.9mm_P0.65mm_SlugUp', 'keywords':'Dual Full-Bridge PWM Motor Driver', 'description':'', 'datasheet':'https://www.ti.com/lit/gpn/DRV8412', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nDRV8432\n\nDual Full-Bridge PWM Motor Driver', 'pins':[
            ...
            Pin(num='12',name='M2',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='M1',func=Pin.types.INPUT,unit=1),
            Pin(num='14',name='PWM_C',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='~{RESET_CD}',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='PWM_D',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='VDD',func=Pin.types.PWRIN,unit=1),
            Pin(num='18',name='GVDD_C',func=Pin.types.PWRIN,unit=1),
            Pin(num='19',name='GVDD_D',func=Pin.types.PWRIN,unit=1),
            Pin(num='2',name='~{OTW}',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='20',name='BST_D',func=Pin.types.INPUT,unit=1),
            Pin(num='21',name='PVDD_D',func=Pin.types.PWRIN,unit=1),
            Pin(num='22',name='OUT_D',func=Pin.types.OUTPUT,unit=1),
            Pin(num='23',name='GND_D',func=Pin.types.PWRIN,unit=1),
            Pin(num='24',name='GND_C',func=Pin.types.PWRIN,unit=1),
            Pin(num='25',name='OUT_C',func=Pin.types.OUTPUT,unit=1),
            Pin(num='26',name='PVDD_C',func=Pin.types.PWRIN,unit=1),
            Pin(num='27',name='BST_C',func=Pin.types.INPUT,unit=1),
            Pin(num='28',name='BST_B',func=Pin.types.INPUT,unit=1),
            Pin(num='29',name='PVDD_B',func=Pin.types.PWRIN,unit=1),
            Pin(num='3',name='~{FAULT}',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='30',name='OUT_B',func=Pin.types.OUTPUT,unit=1),
            Pin(num='31',name='GND_B',func=Pin.types.PWRIN,unit=1),
            Pin(num='32',name='GND_A',func=Pin.types.PWRIN,unit=1),
            Pin(num='33',name='OUT_A',func=Pin.types.OUTPUT,unit=1),
            Pin(num='34',name='PVDD_A',func=Pin.types.PWRIN,unit=1),
            Pin(num='35',name='BST_A',func=Pin.types.INPUT,unit=1),
            Pin(num='36',name='GVDD_A',func=Pin.types.PWRIN,unit=1),
            Pin(num='4',name='PWM_A',func=Pin.types.INPUT,unit=1),
            Pin(num='5',name='~{RESET_AB}',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='PWM_B',func=Pin.types.INPUT,unit=1),
        ...
        Part(**{ 'name':'DRV8461SPWP', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DRV8461SPWP'}), 'ref_prefix':'U', 'fplist':['Package_SO:Texas_PWP0020A'], 'footprint':'Package_SO:Texas_PWP0020A', 'keywords':'texas ti microstep driver silent STEP DIR', 'description':'', 'datasheet':'https://www.ti.com/lit/ds/symlink/drv8461.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nDRV8461SPWP\n\ntexas ti microstep driver silent STEP DIR', 'pins':[
            ...
            Pin(num='17',name='VREF',func=Pin.types.INPUT),
            Pin(num='18',name='~{SCS}',func=Pin.types.INPUT),
            Pin(num='19',name='VCC',func=Pin.types.PWRIN),
            Pin(num='20',name='SDO',func=Pin.types.OUTPUT),
            Pin(num='21',name='SDI',func=Pin.types.INPUT),
            Pin(num='22',name='SCLK',func=Pin.types.INPUT),
            Pin(num='23',name='STEP',func=Pin.types.INPUT),
            Pin(num='24',name='DIR',func=Pin.types.INPUT),
            Pin(num='25',name='ENABLE',func=Pin.types.INPUT),
            Pin(num='26',name='~{SLEEP}',func=Pin.types.INPUT),
            Pin(num='27',name='CPL',func=Pin.types.INPUT),
            Pin(num='28',name='CPH',func=Pin.types.INPUT),
            Pin(num='3',name='GND',func=Pin.types.PWRIN),
            Pin(num='4',name='AOUT1',func=Pin.types.OUTPUT),
            Pin(num='6',name='AOUT2',func=Pin.types.OUTPUT),
            Pin(num='8',name='BOUT2',func=Pin.types.OUTPUT),
            Pin(num='11',name='BOUT1',func=Pin.types.PASSIVE,unit=1),
            Pin(num='12',name='GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='13',name='VM',func=Pin.types.PASSIVE,unit=1),
            Pin(num='14',name='GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='15',name='DVDD',func=Pin.types.PWROUT,unit=1),
            Pin(num='2',name='VM',func=Pin.types.PWRIN,unit=1),
        ...
        Part(**{ 'name':'DRV8662', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DRV8662'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:Texas_RGP0020D_VQFN-20-1EP_4x4mm_P0.5mm_EP2.7x2.7mm_ThermalVias'], 'footprint':'Package_DFN_QFN:Texas_RGP0020D_VQFN-20-1EP_4x4mm_P0.5mm_EP2.7x2.7mm_ThermalVias', 'keywords':'piezo driver boost', 'description':'', 'datasheet':'http://www.ti.com/lit/ds/symlink/drv8662.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nDRV8662\n\npiezo driver boost', 'pins':[
            ...
            Pin(num='12',name='PVDD',func=Pin.types.PWRIN,unit=1),
            Pin(num='13',name='OUT+',func=Pin.types.OUTPUT,unit=1),
            Pin(num='14',name='OUT-',func=Pin.types.OUTPUT,unit=1),
            Pin(num='15',name='REXT',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='IN-',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='IN+',func=Pin.types.INPUT,unit=1),
            Pin(num='18',name='GAIN0',func=Pin.types.INPUT,unit=1),
            Pin(num='19',name='GAIN1',func=Pin.types.INPUT,unit=1),
            Pin(num='2',name='VDD',func=Pin.types.PWRIN,unit=1),
        ...
        Part(**{ 'name':'DRV8711', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DRV8711'}), 'ref_prefix':'U', 'fplist':[''], 'footprint':'', 'keywords':'Stepper driver', 'description':'', 'datasheet':'http://www.ti.com/lit/ds/slvsc40f/slvsc40f.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nDRV8711\n\nStepper driver', 'pins':[
            ...
            Pin(num='12',name='BIN1',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='BIN2',func=Pin.types.INPUT,unit=1),
            Pin(num='14',name='SCLK',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='SDATI',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='SCS',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='SDATO',func=Pin.types.OUTPUT,unit=1),
            Pin(num='18',name='FAULTn',func=Pin.types.OUTPUT,unit=1),
            Pin(num='19',name='STALLn/BEMFVn',func=Pin.types.OUTPUT,unit=1),
            Pin(num='2',name='CP2',func=Pin.types.BIDIR,unit=1),
            Pin(num='20',name='BEMF',func=Pin.types.OUTPUT,unit=1),
            Pin(num='21',name='BOUT2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='22',name='B2HS',func=Pin.types.OUTPUT,unit=1),
            Pin(num='23',name='B2LS',func=Pin.types.OUTPUT,unit=1),
            Pin(num='24',name='BISENN',func=Pin.types.INPUT,unit=1),
            Pin(num='25',name='BISENP',func=Pin.types.INPUT,unit=1),
            Pin(num='26',name='B1LS',func=Pin.types.OUTPUT,unit=1),
            Pin(num='27',name='B1HS',func=Pin.types.OUTPUT,unit=1),
            Pin(num='28',name='BOUT1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='29',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='3',name='VCP',func=Pin.types.BIDIR,unit=1),
            Pin(num='30',name='AOUT2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='31',name='A2HS',func=Pin.types.OUTPUT,unit=1),
            Pin(num='32',name='A2LS',func=Pin.types.OUTPUT,unit=1),
            Pin(num='33',name='AISENN',func=Pin.types.INPUT,unit=1),
            Pin(num='34',name='AISENP',func=Pin.types.INPUT,unit=1),
            Pin(num='35',name='A1LS',func=Pin.types.OUTPUT,unit=1),
            Pin(num='36',name='A1HS',func=Pin.types.OUTPUT,unit=1),
            Pin(num='37',name='AOUT1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='38',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='39',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='4',name='VM',func=Pin.types.PWRIN,unit=1),
            Pin(num='5',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='6',name='V5',func=Pin.types.PWROUT,unit=1),
        ...
        Part(**{ 'name':'DRV8800PWP', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DRV8800PWP'}), 'ref_prefix':'U', 'fplist':['Package_SO:HTSSOP-16-1EP_4.4x5mm_P0.65mm_EP3.4x5mm_Mask3x3mm_ThermalVias'], 'footprint':'Package_SO:HTSSOP-16-1EP_4.4x5mm_P0.65mm_EP3.4x5mm_Mask3x3mm_ThermalVias', 'keywords':'H-Bridge Motor Driver', 'description':'', 'datasheet':'http://www.ti.com/lit/ds/symlink/drv8801.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nDRV8800PWP\n\nH-Bridge Motor Driver', 'pins':[
            ...
            Pin(num='12',name='CP2',func=Pin.types.PWRIN,unit=1),
            Pin(num='13',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='14',name='VCP',func=Pin.types.PWRIN,unit=1),
            Pin(num='15',name='VREG',func=Pin.types.OUTPUT,unit=1),
            Pin(num='16',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='17',name='GND(PPAD)',func=Pin.types.PWRIN,unit=1),
            Pin(num='2',name='MODE',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='PHASE',func=Pin.types.INPUT,unit=1),
            Pin(num='4',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='5',name='~{SLEEP}',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='ENABLE',func=Pin.types.INPUT,unit=1),
        ...
        Part(**{ 'name':'DRV8800RTY', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DRV8800RTY'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:Texas_RTY_WQFN-16-1EP_4x4mm_P0.65mm_EP2.1x2.1mm_ThermalVias'], 'footprint':'Package_DFN_QFN:Texas_RTY_WQFN-16-1EP_4x4mm_P0.65mm_EP2.1x2.1mm_ThermalVias', 'keywords':'H-Bridge Motor Driver', 'description':'', 'datasheet':'http://www.ti.com/lit/ds/symlink/drv8801.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nDRV8800RTY\n\nH-Bridge Motor Driver', 'pins':[
            ...
            Pin(num='13',name='VCP',func=Pin.types.PWRIN,unit=1),
            Pin(num='14',name='VREG',func=Pin.types.OUTPUT,unit=1),
            Pin(num='15',name='~{FAULT}',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='16',name='MODE',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='GND(PPAD)',func=Pin.types.PWRIN,unit=1),
        ...
        Part(**{ 'name':'DRV8801PWP', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DRV8801PWP'}), 'ref_prefix':'U', 'fplist':['Package_SO:HTSSOP-16-1EP_4.4x5mm_P0.65mm_EP3.4x5mm_Mask3x3mm_ThermalVias'], 'footprint':'Package_SO:HTSSOP-16-1EP_4.4x5mm_P0.65mm_EP3.4x5mm_Mask3x3mm_ThermalVias', 'keywords':'H-Bridge Motor Driver', 'description':'', 'datasheet':'http://www.ti.com/lit/ds/symlink/drv8801.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nDRV8801PWP\n\nH-Bridge Motor Driver', 'pins':[
            ...
            Pin(num='13',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='14',name='VCP',func=Pin.types.PWRIN,unit=1),
            Pin(num='15',name='VPROPI',func=Pin.types.OUTPUT,unit=1),
            Pin(num='16',name='MODE2',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='GND(PPAD)',func=Pin.types.PWRIN,unit=1),
            Pin(num='2',name='MODE1',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='PHASE',func=Pin.types.INPUT,unit=1),
            Pin(num='4',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='5',name='~{SLEEP}',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='ENABLE',func=Pin.types.INPUT,unit=1),
        ...
        Part(**{ 'name':'DRV8801RTY', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DRV8801RTY'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:Texas_RTY_WQFN-16-1EP_4x4mm_P0.65mm_EP2.1x2.1mm_ThermalVias'], 'footprint':'Package_DFN_QFN:Texas_RTY_WQFN-16-1EP_4x4mm_P0.65mm_EP2.1x2.1mm_ThermalVias', 'keywords':'H-Bridge Motor Driver', 'description':'', 'datasheet':'http://www.ti.com/lit/ds/symlink/drv8801.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nDRV8801RTY\n\nH-Bridge Motor Driver', 'pins':[
            ...
            Pin(num='12',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='13',name='VCP',func=Pin.types.PWRIN,unit=1),
            Pin(num='14',name='VPROPI',func=Pin.types.OUTPUT,unit=1),
            Pin(num='15',name='~{FAULT}',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='16',name='MODE1',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='GND(PPAD)',func=Pin.types.PWRIN,unit=1),
            Pin(num='2',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='3',name='~{SLEEP}',func=Pin.types.INPUT,unit=1),
            Pin(num='4',name='ENABLE',func=Pin.types.INPUT,unit=1),
            Pin(num='5',name='MODE2',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='OUT+',func=Pin.types.PWROUT,unit=1),
            Pin(num='7',name='SENSE',func=Pin.types.PWROUT,unit=1),
            Pin(num='8',name='VBB',func=Pin.types.PWRIN,unit=1),
            Pin(num='9',name='OUT-',func=Pin.types.PWROUT,unit=1)], 'unit_defs':[] }),
        Part(**{ 'name':'DRV8833PW', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DRV8833PW'}), 'ref_prefix':'U', 'fplist':['Package_SO:TSSOP-16_4.4x5mm_P0.65mm'], 'footprint':'Package_SO:TSSOP-16_4.4x5mm_P0.65mm', 'keywords':'H-bridge motor driver', 'description':'', 'datasheet':'http://www.ti.com/lit/ds/symlink/drv8833.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nDRV8833PW\n\nH-bridge motor driver', 'pins':[
            ...
            Pin(num='12',name='VM',func=Pin.types.PWRIN,unit=1),
            Pin(num='13',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='14',name='VINT',func=Pin.types.PWRIN,unit=1),
            Pin(num='15',name='AIN2',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='AIN1',func=Pin.types.INPUT,unit=1),
            Pin(num='2',name='AOUT1',func=Pin.types.PWROUT,unit=1),
            Pin(num='3',name='AISEN',func=Pin.types.BIDIR,unit=1),
            Pin(num='4',name='AOUT2',func=Pin.types.PWROUT,unit=1),
            Pin(num='5',name='BOUT2',func=Pin.types.PWROUT,unit=1),
            Pin(num='6',name='BISEN',func=Pin.types.BIDIR,unit=1),
        ...
        Part(**{ 'name':'DRV8833RTY', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DRV8833RTY'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:Texas_RTY_WQFN-16-1EP_4x4mm_P0.65mm_EP2.1x2.1mm_ThermalVias'], 'footprint':'Package_DFN_QFN:Texas_RTY_WQFN-16-1EP_4x4mm_P0.65mm_EP2.1x2.1mm_ThermalVias', 'keywords':'H-bridge motor driver', 'description':'', 'datasheet':'http://www.ti.com/lit/ds/symlink/drv8833.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nDRV8833RTY\n\nH-bridge motor driver', 'pins':[
            ...
            Pin(num='12',name='VINT',func=Pin.types.PWRIN,unit=1),
            Pin(num='13',name='AIN2',func=Pin.types.INPUT,unit=1),
            Pin(num='14',name='AIN1',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='~{SLEEP}',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='AOUT1',func=Pin.types.PWROUT,unit=1),
            Pin(num='17',name='GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='2',name='AOUT2',func=Pin.types.PWROUT,unit=1),
            Pin(num='3',name='BOUT2',func=Pin.types.PWROUT,unit=1),
            Pin(num='4',name='BISEN',func=Pin.types.BIDIR,unit=1),
            Pin(num='5',name='BOUT1',func=Pin.types.PWROUT,unit=1),
        ...
        Part(**{ 'name':'DRV8847PWP', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DRV8847PWP'}), 'ref_prefix':'U', 'fplist':['Package_SO:HTSSOP-16-1EP_4.4x5mm_P0.65mm_EP3.4x5mm_Mask2.46x2.31mm_ThermalVias'], 'footprint':'Package_SO:HTSSOP-16-1EP_4.4x5mm_P0.65mm_EP3.4x5mm_Mask2.46x2.31mm_ThermalVias', 'keywords':'Dual H-Bridge motor driver', 'description':'', 'datasheet':'https://www.ti.com/lit/ds/symlink/drv8847.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nDRV8847PWP\n\nDual H-Bridge motor driver', 'pins':[
            ...
            Pin(num='15',name='IN2',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='IN1',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='PPAD',func=Pin.types.PWRIN,unit=1),
            Pin(num='2',name='OUT1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='3',name='ISEN12',func=Pin.types.PASSIVE,unit=1),
            Pin(num='4',name='OUT2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='5',name='OUT4',func=Pin.types.OUTPUT,unit=1),
            Pin(num='6',name='ISEN34',func=Pin.types.PASSIVE,unit=1),
        ...
        Part(**{ 'name':'DRV8847RTE', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DRV8847RTE'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:QFN-16-1EP_3x3mm_P0.5mm_EP1.7x1.7mm_ThermalVias'], 'footprint':'Package_DFN_QFN:QFN-16-1EP_3x3mm_P0.5mm_EP1.7x1.7mm_ThermalVias', 'keywords':'Dual H-Bridge motor driver', 'description':'', 'datasheet':'https://www.ti.com/lit/ds/symlink/drv8847.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nDRV8847RTE\n\nDual H-Bridge motor driver', 'pins':[
            ...
            Pin(num='13',name='IN2',func=Pin.types.INPUT,unit=1),
            ...
            Pin(num='3',name='OUT4',func=Pin.types.OUTPUT,unit=1),
            Pin(num='4',name='ISEN34',func=Pin.types.PASSIVE,unit=1),
        ...
        Part(**{ 'name':'DRV8848', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DRV8848'}), 'ref_prefix':'U', 'fplist':['Package_SO:TSSOP-16-1EP_4.4x5mm_P0.65mm'], 'footprint':'Package_SO:TSSOP-16-1EP_4.4x5mm_P0.65mm', 'keywords':'Dual H-Bridge motor driver', 'description':'', 'datasheet':'http://www.ti.com/lit/ds/symlink/drv8848.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nDRV8848\n\nDual H-Bridge motor driver', 'pins':[
            ...
            Pin(num='12',name='VM',func=Pin.types.PWRIN,unit=1),
            Pin(num='13',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='14',name='VINT',func=Pin.types.PASSIVE,unit=1),
            Pin(num='15',name='AIN2',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='AIN1',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='2',name='AOUT1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='3',name='AISEN',func=Pin.types.PASSIVE,unit=1),
            Pin(num='4',name='AOUT2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='5',name='BOUT2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='6',name='BISEN',func=Pin.types.PASSIVE,unit=1),
        ...
        Part(**{ 'name':'DRV8870DDA', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DRV8870DDA'}), 'ref_prefix':'U', 'fplist':['Package_SO:Texas_HTSOP-8-1EP_3.9x4.9mm_P1.27mm_EP2.95x4.9mm_Mask2.4x3.1mm_ThermalVias'], 'footprint':'Package_SO:Texas_HTSOP-8-1EP_3.9x4.9mm_P1.27mm_EP2.95x4.9mm_Mask2.4x3.1mm_ThermalVias', 'keywords':'H-bridge driver motor current limit', 'description':'', 'datasheet':'http://www.ti.com/lit/ds/symlink/drv8870.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nDRV8870DDA\n\nH-bridge driver motor current limit', 'pins':[
            ...
            Pin(num='5',name='VM',func=Pin.types.PWRIN,unit=1),
        ...
        Part(**{ 'name':'DRV8872DDA', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'DRV8872DDA'}), 'ref_prefix':'U', 'fplist':['Package_SO:Texas_HTSOP-8-1EP_3.9x4.9mm_P1.27mm_EP2.95x4.9mm_Mask2.4x3.1mm_ThermalVias'], 'footprint':'Package_SO:Texas_HTSOP-8-1EP_3.9x4.9mm_P1.27mm_EP2.95x4.9mm_Mask2.4x3.1mm_ThermalVias', 'keywords':'H-bridge driver motor current limit', 'description':'', 'datasheet':'http://www.ti.com/lit/ds/symlink/drv8872.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nDRV8872DDA\n\nH-bridge driver motor current limit', 'pins':[
            ...
            Pin(num='2',name='IN2',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='IN1',func=Pin.types.INPUT,unit=1),
            Pin(num='4',name='nFAULT',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='5',name='VM',func=Pin.types.PWRIN,unit=1),
            Pin(num='6',name='OUT1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='7',name='ISEN',func=Pin.types.PASSIVE,unit=1),
            Pin(num='8',name='OUT2',func=Pin.types.OUTPUT,unit=1),
        ...
        Part(**{ 'name':'L293', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'L293'}), 'ref_prefix':'U', 'fplist':['Package_DIP:DIP-16_W7.62mm'], 'footprint':'Package_DIP:DIP-16_W7.62mm', 'keywords':'Half-H Driver Motor', 'description':'', 'datasheet':'http://www.ti.com/lit/ds/symlink/l293.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nL293\n\nHalf-H Driver Motor', 'pins':[
            ...
            Pin(num='12',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='13',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='14',name='4Y',func=Pin.types.OUTPUT,unit=1),
            Pin(num='15',name='4A',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='VCC1',func=Pin.types.PWRIN,unit=1),
            Pin(num='2',name='1A',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='1Y',func=Pin.types.OUTPUT,unit=1),
            Pin(num='4',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='5',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='6',name='2Y',func=Pin.types.OUTPUT,unit=1),
        ...
        Part(**{ 'name':'L293E', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'L293E'}), 'ref_prefix':'U', 'fplist':['Package_DIP:DIP-20_W7.62mm'], 'footprint':'Package_DIP:DIP-20_W7.62mm', 'keywords':'Half-H Driver Motor Sense', 'description':'', 'datasheet':'https://www.st.com/resource/en/datasheet/l293e.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nL293E\n\nHalf-H Driver Motor Sense', 'pins':[
            ...
            Pin(num='12',name='IN3',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='OUT3',func=Pin.types.OUTPUT,unit=1),
            Pin(num='14',name='SENSE3',func=Pin.types.PASSIVE,unit=1),
            Pin(num='15',name='GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='16',name='GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='17',name='SENSE4',func=Pin.types.PASSIVE,unit=1),
            Pin(num='18',name='OUT4',func=Pin.types.OUTPUT,unit=1),
            Pin(num='19',name='IN4',func=Pin.types.INPUT,unit=1),
            ...
            Pin(num='4',name='SENSE1',func=Pin.types.PASSIVE,unit=1),
            Pin(num='5',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='6',name='GND',func=Pin.types.PASSIVE,unit=1),
        ...
        Part(**{ 'name':'L297', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'L297'}), 'ref_prefix':'U', 'fplist':[''], 'footprint':'', 'keywords':'Stepper Motor Controller', 'description':'', 'datasheet':'www.st.com/resource/en/datasheet/cd00000063.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nL297\n\nStepper Motor Controller', 'pins':[
            ...
            Pin(num='14',name='SENS1',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='Vref',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='OSC',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='CW',func=Pin.types.INPUT,unit=1),
            Pin(num='18',name='CLOCK',func=Pin.types.INPUT,unit=1),
            Pin(num='19',name='HALF',func=Pin.types.INPUT,unit=1),
            Pin(num='20',name='RESET',func=Pin.types.INPUT,unit=1),
            Pin(num='1',name='SYNC',func=Pin.types.BIDIR,unit=1),
            Pin(num='10',name='ENABLE',func=Pin.types.INPUT,unit=1),
            Pin(num='2',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='3',name='HOME',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='4',name='A',func=Pin.types.OUTPUT,unit=1),
            Pin(num='5',name='INH1',func=Pin.types.OUTPUT,unit=1),
        ...
        Part(**{ 'name':'L298HN', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'L298HN'}), 'ref_prefix':'U', 'fplist':['Package_TO_SOT_THT:TO-220-15_P2.54x2.54mm_StaggerOdd_Lead5.84mm_TabDown'], 'footprint':'Package_TO_SOT_THT:TO-220-15_P2.54x2.54mm_StaggerOdd_Lead5.84mm_TabDown', 'keywords':'H-bridge motor driver', 'description':'', 'datasheet':'http://www.st.com/st-web-ui/static/active/en/resource/technical/document/datasheet/CD00000240.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nL298HN\n\nH-bridge motor driver', 'pins':[
            ...
            Pin(num='15',name='SENSE_B',func=Pin.types.PWRIN,unit=1),
            Pin(num='2',name='OUT1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='3',name='OUT2',func=Pin.types.OUTPUT,unit=1),
        ...
        Part(**{ 'name':'L298P', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'L298P'}), 'ref_prefix':'U', 'fplist':[''], 'footprint':'', 'keywords':'H-bridge motor driver', 'description':'', 'datasheet':'http://www.st.com/st-web-ui/static/active/en/resource/technical/document/datasheet/CD00000240.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nL298P\n\nH-bridge motor driver', 'pins':[
            ...
            Pin(num='15',name='IN4',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='OUT3',func=Pin.types.OUTPUT,unit=1),
            Pin(num='17',name='OUT4',func=Pin.types.OUTPUT,unit=1),
            Pin(num='18',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='19',name='SENSE_B',func=Pin.types.PWRIN,unit=1),
            Pin(num='2',name='SENSE_A',func=Pin.types.PWRIN,unit=1),
        ...
        Part(**{ 'name':'LMD18200', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'LMD18200'}), 'ref_prefix':'U', 'fplist':['Package_TO_SOT_THT:TO-220-11_P3.4x5.08mm_StaggerOdd_Lead4.85mm_Vertical'], 'footprint':'Package_TO_SOT_THT:TO-220-11_P3.4x5.08mm_StaggerOdd_Lead4.85mm_Vertical', 'keywords':'H-Bridge DC stepper servo motor driver Motion Control Applications', 'description':'', 'datasheet':'http://www.ti.com/lit/ds/symlink/lmd18200.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nLMD18200\n\nH-Bridge DC stepper servo motor driver Motion Control Applications', 'pins':[
            ...
            Pin(num='2',name='OUTPUT1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='3',name='DIRECTION',func=Pin.types.INPUT,unit=1),
            Pin(num='4',name='BRAKE',func=Pin.types.INPUT,unit=1),
            Pin(num='5',name='PWM',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='VS',func=Pin.types.PWRIN,unit=1),
        ...
        Part(**{ 'name':'MAX22201', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'MAX22201'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:Maxim_TDFN-12-1EP_3x3mm_P0.5mm_EP1.7x2.5mm_ThermalVias'], 'footprint':'Package_DFN_QFN:Maxim_TDFN-12-1EP_3x3mm_P0.5mm_EP1.7x2.5mm_ThermalVias', 'keywords':'Brushed Motor Driver', 'description':'', 'datasheet':'https://www.analog.com/media/en/technical-documentation/data-sheets/max22201-max22207.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nMAX22201\n\nBrushed Motor Driver', 'pins':[
            ...
            Pin(num='13',name='PAD',func=Pin.types.PASSIVE,unit=1),
            Pin(num='2',name='ROFF',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='GNDP',func=Pin.types.PWRIN,unit=1),
            Pin(num='4',name='IN1',func=Pin.types.INPUT,unit=1),
            Pin(num='5',name='IN2',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='ISEN',func=Pin.types.OUTPUT,unit=1),
        ...
        Part(**{ 'name':'MAX22202', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'MAX22202'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:Maxim_TDFN-12-1EP_3x3mm_P0.5mm_EP1.7x2.5mm_ThermalVias'], 'footprint':'Package_DFN_QFN:Maxim_TDFN-12-1EP_3x3mm_P0.5mm_EP1.7x2.5mm_ThermalVias', 'keywords':'Brushed Motor Driver', 'description':'', 'datasheet':'https://www.analog.com/media/en/technical-documentation/data-sheets/max22201-max22207.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nMAX22202\n\nBrushed Motor Driver', 'pins':[
            ...
            Pin(num='2',name='MODE',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='GNDP',func=Pin.types.PWRIN,unit=1),
            Pin(num='4',name='PHASE',func=Pin.types.INPUT,unit=1),
            Pin(num='5',name='ENBL',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='ISEN',func=Pin.types.OUTPUT,unit=1),
            Pin(num='7',name='V_{18}',func=Pin.types.PWROUT,unit=1),
            Pin(num='8',name='GNDA',func=Pin.types.PWRIN,unit=1),
            Pin(num='9',name='OUT2',func=Pin.types.OUTPUT,unit=1)], 'unit_defs':[] }),
        Part(**{ 'name':'MAX22207', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'MAX22207'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:Maxim_TDFN-12-1EP_3x3mm_P0.5mm_EP1.7x2.5mm_ThermalVias'], 'footprint':'Package_DFN_QFN:Maxim_TDFN-12-1EP_3x3mm_P0.5mm_EP1.7x2.5mm_ThermalVias', 'keywords':'Brushed Motor Driver', 'description':'', 'datasheet':'https://www.analog.com/media/en/technical-documentation/data-sheets/max22201-max22207.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nMAX22207\n\nBrushed Motor Driver', 'pins':[
            ...
            Pin(num='12',name='~{FAULT}',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='13',name='PAD',func=Pin.types.PASSIVE,unit=1),
            Pin(num='2',name='~{CDROUT}',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='3',name='GNDP',func=Pin.types.PWRIN,unit=1),
            Pin(num='4',name='IN1',func=Pin.types.INPUT,unit=1),
            Pin(num='5',name='IN2',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='ISEN',func=Pin.types.OUTPUT,unit=1),
        ...
        Part(**{ 'name':'PAC5527QM', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'PAC5527QM'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:Qorvo_TQFN66-48-1EP_6x6mm_P0.4mm_EP4.2x4.2mm'], 'footprint':'Package_DFN_QFN:Qorvo_TQFN66-48-1EP_6x6mm_P0.4mm_EP4.2x4.2mm', 'keywords':'mcu motor driver', 'description':'', 'datasheet':'https://www.qorvo.com/products/d/da006847', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nPAC5527QM\n\nmcu motor driver', 'pins':[
            ...
            Pin(num='12',name='AIO6',func=Pin.types.BIDIR,unit=1),
            Pin(num='13',name='AIO7',func=Pin.types.BIDIR,unit=1),
            Pin(num='14',name='AIO8',func=Pin.types.BIDIR,unit=1),
            Pin(num='15',name='AIO9',func=Pin.types.BIDIR,unit=1),
            Pin(num='16',name='VSYS',func=Pin.types.PWROUT,unit=1),
            Pin(num='17',name='VM',func=Pin.types.PWRIN,unit=1),
            Pin(num='18',name='SW1',func=Pin.types.INPUT,unit=1),
            Pin(num='19',name='SW2',func=Pin.types.INPUT,unit=1),
            Pin(num='2',name='PF1',func=Pin.types.BIDIR,unit=1),
            Pin(num='20',name='VP',func=Pin.types.PWROUT,unit=1),
            Pin(num='21',name='CPL',func=Pin.types.INPUT,unit=1),
            Pin(num='22',name='CPH',func=Pin.types.INPUT,unit=1),
            Pin(num='23',name='DRL0',func=Pin.types.OUTPUT,unit=1),
            Pin(num='24',name='DRL1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='25',name='DRL2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='26',name='DRS0',func=Pin.types.OUTPUT,unit=1),
            Pin(num='27',name='DRH0',func=Pin.types.OUTPUT,unit=1),
            Pin(num='28',name='DRS1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='29',name='DRH1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='3',name='PF0',func=Pin.types.BIDIR,unit=1),
            Pin(num='30',name='DRS2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='31',name='DRH2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='32',name='VCP',func=Pin.types.PASSIVE,unit=1),
            Pin(num='33',name='PD7',func=Pin.types.BIDIR,unit=1),
            Pin(num='34',name='PD6',func=Pin.types.BIDIR,unit=1),
            Pin(num='35',name='PD5',func=Pin.types.BIDIR,unit=1),
            Pin(num='36',name='PD4',func=Pin.types.BIDIR,unit=1),
            Pin(num='37',name='PE0',func=Pin.types.BIDIR,unit=1),
            Pin(num='38',name='PE1',func=Pin.types.BIDIR,unit=1),
            Pin(num='39',name='PE2',func=Pin.types.BIDIR,unit=1),
            Pin(num='4',name='VCC33',func=Pin.types.PWROUT,unit=1),
            Pin(num='40',name='PE3',func=Pin.types.BIDIR,unit=1),
            Pin(num='41',name='VCC18',func=Pin.types.PWROUT,unit=1),
            Pin(num='42',name='VCORE',func=Pin.types.PWROUT,unit=1),
            Pin(num='43',name='VCCIO',func=Pin.types.PWROUT,unit=1),
            Pin(num='44',name='PF7',func=Pin.types.BIDIR,unit=1),
            Pin(num='45',name='PF6',func=Pin.types.BIDIR,unit=1),
            Pin(num='46',name='PF5',func=Pin.types.BIDIR,unit=1),
            Pin(num='47',name='PF4',func=Pin.types.BIDIR,unit=1),
            Pin(num='48',name='PF3',func=Pin.types.BIDIR,unit=1),
            Pin(num='49',name='VSS',func=Pin.types.PASSIVE,unit=1),
            Pin(num='5',name='VSS',func=Pin.types.PWRIN,unit=1),
            Pin(num='6',name='AIO0',func=Pin.types.BIDIR,unit=1),
        ...
        Part(**{ 'name':'PG001M', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'PG001M'}), 'ref_prefix':'U', 'fplist':[''], 'footprint':'', 'keywords':'Support IC for SLA7042M/SLA7044M', 'description':'', 'datasheet':'http://www.allegromicro.com/~/media/Files/Sanken/Datasheets/PG001M-Datasheet.ashx', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nPG001M\n\nSupport IC for SLA7042M/SLA7044M', 'pins':[
            ...
            Pin(num='13',name='~{STROBE}',func=Pin.types.OUTPUT,unit=1),
            Pin(num='14',name='CLK_OUT',func=Pin.types.OUTPUT,unit=1),
            Pin(num='15',name='VECTOR',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='Vdd',func=Pin.types.PWRIN,unit=1),
            Pin(num='2',name='CLK_IN',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='~{CW}',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='MSEL_1',func=Pin.types.INPUT,unit=1),
        ...
        Part(**{ 'name':'Pololu_Breakout_A4988', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'Pololu_Breakout_A4988'}), 'ref_prefix':'A', 'fplist':['Module:Pololu_Breakout-16_15.2x20.3mm'], 'footprint':'Module:Pololu_Breakout-16_15.2x20.3mm', 'keywords':'Pololu Breakout Board Stepper Driver A4988', 'description':'', 'datasheet':'https://www.pololu.com/product/2980/pictures', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nPololu_Breakout_A4988\n\nPololu Breakout Board Stepper Driver A4988', 'pins':[
            ...
            Pin(num='12',name='MS3',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='~{RESET}',func=Pin.types.INPUT,unit=1),
            Pin(num='14',name='~{SLEEP}',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='STEP',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='DIR',func=Pin.types.INPUT,unit=1),
            Pin(num='2',name='VDD',func=Pin.types.PWRIN,unit=1),
            Pin(num='3',name='1B',func=Pin.types.OUTPUT,unit=1),
            Pin(num='4',name='1A',func=Pin.types.OUTPUT,unit=1),
            Pin(num='5',name='2A',func=Pin.types.OUTPUT,unit=1),
            Pin(num='6',name='2B',func=Pin.types.OUTPUT,unit=1),
            Pin(num='7',name='GND',func=Pin.types.PWRIN,unit=1),
        ...
        Part(**{ 'name':'Pololu_Breakout_DRV8825', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'Pololu_Breakout_DRV8825'}), 'ref_prefix':'A', 'fplist':['Module:Pololu_Breakout-16_15.2x20.3mm'], 'footprint':'Module:Pololu_Breakout-16_15.2x20.3mm', 'keywords':'Pololu Breakout Board Stepper Driver DRV8825', 'description':'', 'datasheet':'https://www.pololu.com/product/2982', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nPololu_Breakout_DRV8825\n\nPololu Breakout Board Stepper Driver DRV8825', 'pins':[
            ...
            Pin(num='12',name='M2',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='~{RST}',func=Pin.types.INPUT,unit=1),
            Pin(num='14',name='~{SLP}',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='STEP',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='DIR',func=Pin.types.INPUT,unit=1),
            Pin(num='2',name='~{FLT}',func=Pin.types.OUTPUT,unit=1),
            Pin(num='3',name='A2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='4',name='A1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='5',name='B1',func=Pin.types.OUTPUT,unit=1),
        ...
        Part(**{ 'name':'SLA7044M', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'SLA7044M'}), 'ref_prefix':'U', 'fplist':[''], 'footprint':'', 'keywords':'Stepper driver', 'description':'', 'datasheet':'http://www.sumzi.com/upload/files/2007/07/2007073114282034189.PDF', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nSLA7044M\n\nStepper driver', 'pins':[
            ...
            Pin(num='5',name='~{CLOCK}',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='DATA',func=Pin.types.INPUT,unit=1),
            Pin(num='7',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='8',name='~{OUT}',func=Pin.types.OUTPUT,unit=1),
            Pin(num='9',name='RS',func=Pin.types.INPUT,unit=1),
            Pin(num='10',name='RS',func=Pin.types.INPUT,unit=2),
            Pin(num='11',name='OUT',func=Pin.types.OUTPUT,unit=2),
            Pin(num='12',name='GND',func=Pin.types.PWRIN,unit=2),
            Pin(num='13',name='~{STROBE}',func=Pin.types.INPUT,unit=2),
            Pin(num='14',name='REF',func=Pin.types.INPUT,unit=2),
        ...
        Part(**{ 'name':'SLA7070MPRT', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'SLA7070MPRT'}), 'ref_prefix':'U', 'fplist':[''], 'footprint':'', 'keywords':'Stepper driver', 'description':'', 'datasheet':'http://www.semicon.sanken-ele.co.jp/sk_content/sla7070mprt_ds_en.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nSLA7070MPRT\n\nStepper driver', 'pins':[
            ...
            Pin(num='12',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='13',name='REF/SLEEP1',func=Pin.types.INPUT,unit=1),
            Pin(num='14',name='VDD',func=Pin.types.PWRIN,unit=1),
            Pin(num='15',name='RESET',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='CW/CCW',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='SYNC',func=Pin.types.INPUT,unit=1),
            Pin(num='18',name='FLAG',func=Pin.types.OUTPUT,unit=1),
            Pin(num='19',name='SENSE_B',func=Pin.types.OUTPUT,unit=1),
            Pin(num='2',name='OUTA',func=Pin.types.OUTPUT,unit=1),
            Pin(num='20',name='~{OUTB}',func=Pin.types.OUTPUT,unit=1),
            Pin(num='21',name='~{OUTB}',func=Pin.types.OUTPUT,unit=1),
            Pin(num='22',name='OUTB',func=Pin.types.OUTPUT,unit=1),
            Pin(num='23',name='OUTB',func=Pin.types.OUTPUT,unit=1),
            Pin(num='3',name='~{OUTA}',func=Pin.types.OUTPUT,unit=1),
            Pin(num='4',name='~{OUTA}',func=Pin.types.OUTPUT,unit=1),
            Pin(num='5',name='SENSE_A',func=Pin.types.OUTPUT,unit=1),
        ...
        Part(**{ 'name':'SLA7075MPRT', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'SLA7075MPRT'}), 'ref_prefix':'U', 'fplist':[''], 'footprint':'', 'keywords':'Stepper driver', 'description':'', 'datasheet':'http://www.semicon.sanken-ele.co.jp/sk_content/sla7075mprt_ds_en.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nSLA7075MPRT\n\nStepper driver', 'pins':[
            ...
            Pin(num='4',name='~{OUTA}',func=Pin.types.OUTPUT,unit=1),
            Pin(num='5',name='SENSE_A',func=Pin.types.OUTPUT,unit=1),
            Pin(num='6',name='MO',func=Pin.types.OUTPUT,unit=1),
            Pin(num='7',name='M1',func=Pin.types.INPUT,unit=1),
            Pin(num='8',name='M2',func=Pin.types.INPUT,unit=1),
            Pin(num='9',name='M3',func=Pin.types.INPUT,unit=1)], 'unit_defs':[] }),
        ...
        Part(**{ 'name':'STK672-040-E', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'STK672-040-E'}), 'ref_prefix':'U', 'fplist':[''], 'footprint':'', 'keywords':'Stepper driver', 'description':'', 'datasheet':'http://www.onsemi.com/pub_link/Collateral/EN5227-D.PDF', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nSTK672-040-E\n\nStepper driver', 'pins':[
            ...
            Pin(num='11',name='M3',func=Pin.types.INPUT,unit=1),
            Pin(num='12',name='M4',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='M5',func=Pin.types.INPUT,unit=1),
            Pin(num='14',name='CLK',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='CWB',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='~{RESET}',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='RETURN',func=Pin.types.INPUT,unit=1),
            Pin(num='18',name='ENABLE',func=Pin.types.INPUT,unit=1),
            Pin(num='19',name='MOI',func=Pin.types.OUTPUT,unit=1),
            Pin(num='2',name='B',func=Pin.types.OUTPUT,unit=1),
            Pin(num='20',name='MO1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='21',name='MO2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='22',name='SG',func=Pin.types.PWRIN,unit=1),
            Pin(num='3',name='PG',func=Pin.types.PWRIN,unit=1),
            Pin(num='4',name='PG',func=Pin.types.PWRIN,unit=1),
            Pin(num='5',name='~{A}',func=Pin.types.OUTPUT,unit=1),
        ...
        Part(**{ 'name':'STK672-080-E', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'STK672-080-E'}), 'ref_prefix':'U', 'fplist':[''], 'footprint':'', 'keywords':'Stepper driver', 'description':'', 'datasheet':'http://www.onsemi.com/pub_link/Collateral/EN6507-D.PDF', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nSTK672-080-E\n\nStepper driver', 'pins':[
            ...
            Pin(num='12',name='M3',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='~{RESET}',func=Pin.types.INPUT,unit=1),
            Pin(num='14',name='MOI',func=Pin.types.OUTPUT,unit=1),
            Pin(num='15',name='ENABLE',func=Pin.types.INPUT,unit=1),
            Pin(num='2',name='BB',func=Pin.types.OUTPUT,unit=1),
            Pin(num='3',name='B',func=Pin.types.OUTPUT,unit=1),
            Pin(num='4',name='AB',func=Pin.types.OUTPUT,unit=1),
            Pin(num='5',name='A',func=Pin.types.OUTPUT,unit=1),
        ...
        Part(**{ 'name':'STSPIN220', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'STSPIN220'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:VQFN-16-1EP_3x3mm_P0.5mm_EP1.8x1.8mm'], 'footprint':'Package_DFN_QFN:VQFN-16-1EP_3x3mm_P0.5mm_EP1.8x1.8mm', 'keywords':'motor driver stepper', 'description':'', 'datasheet':'www.st.com/resource/en/datasheet/stspin220.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nSTSPIN220\n\nmotor driver stepper', 'pins':[
            ...
            Pin(num='12',name='TOFF',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='EN/FLT',func=Pin.types.BIDIR,unit=1),
            Pin(num='14',name='STBY/RESET',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='MODE2',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='MODE1',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='EPAD',func=Pin.types.PWRIN,unit=1),
            Pin(num='2',name='STCK',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='OUTA1',func=Pin.types.PWROUT,unit=1),
            Pin(num='4',name='SENSEA',func=Pin.types.PWROUT,unit=1),
            Pin(num='5',name='OUTA2',func=Pin.types.PWROUT,unit=1),
            Pin(num='6',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='7',name='GND',func=Pin.types.PWRIN,unit=1),
        ...
        Part(**{ 'name':'STSPIN230', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'STSPIN230'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:VQFN-16-1EP_3x3mm_P0.5mm_EP1.8x1.8mm'], 'footprint':'Package_DFN_QFN:VQFN-16-1EP_3x3mm_P0.5mm_EP1.8x1.8mm', 'keywords':'motor driver half-bridge', 'description':'', 'datasheet':'www.st.com/resource/en/datasheet/stspin230.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nSTSPIN230\n\nmotor driver half-bridge', 'pins':[
            ...
            Pin(num='12',name='INWH',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='EN/FLT',func=Pin.types.BIDIR,unit=1),
            Pin(num='14',name='STBY',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='INVL',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='INVH',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='2',name='INUH',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='OUTU',func=Pin.types.PWROUT,unit=1),
            Pin(num='4',name='SENSEU',func=Pin.types.INPUT,unit=1),
            Pin(num='5',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='6',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='7',name='GND',func=Pin.types.PWRIN,unit=1),
        ...
        Part(**{ 'name':'STSPIN233', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'STSPIN233'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:VQFN-16-1EP_3x3mm_P0.5mm_EP1.8x1.8mm'], 'footprint':'Package_DFN_QFN:VQFN-16-1EP_3x3mm_P0.5mm_EP1.8x1.8mm', 'keywords':'motor driver half-bridge', 'description':'', 'datasheet':'www.st.com/resource/en/datasheet/stspin233.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nSTSPIN233\n\nmotor driver half-bridge', 'pins':[
            ...
            Pin(num='12',name='ENW',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='EN/FAULT',func=Pin.types.BIDIR,unit=1),
            Pin(num='14',name='STBY/RESET',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='INV',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='ENV',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='2',name='ENU',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='OUTU',func=Pin.types.PWROUT,unit=1),
            Pin(num='4',name='SENSEU',func=Pin.types.INPUT,unit=1),
        ...
        Part(**{ 'name':'STSPIN240', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'STSPIN240'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:VQFN-16-1EP_3x3mm_P0.5mm_EP1.8x1.8mm'], 'footprint':'Package_DFN_QFN:VQFN-16-1EP_3x3mm_P0.5mm_EP1.8x1.8mm', 'keywords':'motor driver dc brushed', 'description':'', 'datasheet':'www.st.com/resource/en/datasheet/stspin240.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nSTSPIN240\n\nmotor driver dc brushed', 'pins':[
            ...
            Pin(num='13',name='EN/FLT',func=Pin.types.BIDIR,unit=1),
            Pin(num='14',name='STBY/RESET',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='PHB',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='PWMB',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='EPAD',func=Pin.types.PWRIN,unit=1),
            Pin(num='2',name='PWMA',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='OUTA1',func=Pin.types.PWROUT,unit=1),
            Pin(num='4',name='SENSEA',func=Pin.types.PWROUT,unit=1),
            Pin(num='5',name='OUTA2',func=Pin.types.PWROUT,unit=1),
            Pin(num='6',name='VS',func=Pin.types.PWRIN,unit=1),
        ...
        Part(**{ 'name':'TB6612FNG', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'TB6612FNG'}), 'ref_prefix':'U', 'fplist':['Package_SO:SSOP-24_5.3x8.2mm_P0.65mm'], 'footprint':'Package_SO:SSOP-24_5.3x8.2mm_P0.65mm', 'keywords':'H-bridge motor driver', 'description':'', 'datasheet':'https://toshiba.semicon-storage.com/us/product/linear/motordriver/detail.TB6612FNG.html', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nTB6612FNG\n\nH-bridge motor driver', 'pins':[
            ...
            Pin(num='12',name='BO1',func=Pin.types.PASSIVE,unit=1),
            Pin(num='13',name='VM2',func=Pin.types.PWRIN,unit=1),
            Pin(num='14',name='VM3',func=Pin.types.PWRIN,unit=1),
            Pin(num='15',name='PWMB',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='BIN2',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='BIN1',func=Pin.types.INPUT,unit=1),
            Pin(num='18',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='19',name='STBY',func=Pin.types.INPUT,unit=1),
            Pin(num='2',name='AO1',func=Pin.types.PASSIVE,unit=1),
            Pin(num='20',name='VCC',func=Pin.types.PWRIN,unit=1),
            Pin(num='21',name='AIN1',func=Pin.types.INPUT,unit=1),
            Pin(num='22',name='AIN2',func=Pin.types.INPUT,unit=1),
            Pin(num='23',name='PWMA',func=Pin.types.INPUT,unit=1),
            Pin(num='24',name='VM1',func=Pin.types.PWRIN,unit=1),
            Pin(num='3',name='PGND1',func=Pin.types.PWRIN,unit=1),
            Pin(num='4',name='PGND1',func=Pin.types.PASSIVE,unit=1),
            Pin(num='5',name='AO2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='6',name='AO2',func=Pin.types.PASSIVE,unit=1),
        ...
        Part(**{ 'name':'TC78H670FTG', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'TC78H670FTG'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:VQFN-16-1EP_3x3mm_P0.5mm_EP1.8x1.8mm'], 'footprint':'Package_DFN_QFN:VQFN-16-1EP_3x3mm_P0.5mm_EP1.8x1.8mm', 'keywords':'stepping motor driver', 'description':'', 'datasheet':'https://toshiba.semicon-storage.com/info/TC78H670FTG_datasheet_en_20210209.pdf?did=68606&prodName=TC78H670FTG', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nTC78H670FTG\n\nstepping motor driver', 'pins':[
            ...
            Pin(num='5',name='OUT_A+',func=Pin.types.OUTPUT),
            Pin(num='6',name='OUT_A-',func=Pin.types.OUTPUT),
            Pin(num='7',name='OUT_B-',func=Pin.types.OUTPUT),
            Pin(num='8',name='OUT_B+',func=Pin.types.OUTPUT),
            Pin(num='1',name='MODE3',func=Pin.types.INPUT,unit=1),
            Pin(num='10',name='VREF',func=Pin.types.INPUT,unit=1),
            Pin(num='11',name='OSCM',func=Pin.types.INPUT,unit=1),
            Pin(num='12',name='~{STBY}',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='EN/~{ERR}',func=Pin.types.BIDIR,unit=1),
            Pin(num='14',name='MODE0',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='MODE1',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='MODE2',func=Pin.types.INPUT,unit=1),
        ...
        Part(**{ 'name':'TMC2041-LA', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'TMC2041-LA'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:QFN-48-1EP_7x7mm_P0.5mm_EP5.3x5.3mm_ThermalVias'], 'footprint':'Package_DFN_QFN:QFN-48-1EP_7x7mm_P0.5mm_EP5.3x5.3mm_ThermalVias', 'keywords':'Dual driver stepper motor', 'description':'', 'datasheet':'https://www.trinamic.com/fileadmin/assets/Products/ICs_Documents/TMC2041_datasheet.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nTMC2041-LA\n\nDual driver stepper motor', 'pins':[
            ...
            Pin(num='12',name='SWSEL',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='GNDD',func=Pin.types.PASSIVE,unit=1),
            Pin(num='14',name='O2A1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='15',name='BR2A',func=Pin.types.PASSIVE,unit=1),
            Pin(num='16',name='O2A2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='17',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='18',name='GNDP',func=Pin.types.PWRIN,unit=1),
            Pin(num='19',name='VS',func=Pin.types.PASSIVE,unit=1),
            Pin(num='2',name='GNDD',func=Pin.types.PASSIVE,unit=1),
            Pin(num='20',name='O2B1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='21',name='BR2B',func=Pin.types.PASSIVE,unit=1),
            Pin(num='22',name='O2B2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='23',name='GNDD',func=Pin.types.PASSIVE,unit=1),
            Pin(num='24',name='NEXTADDR',func=Pin.types.INPUT,unit=1),
            Pin(num='25',name='DIR2',func=Pin.types.INPUT,unit=1),
            Pin(num='26',name='STEP2',func=Pin.types.INPUT,unit=1),
            Pin(num='27',name='DIR1',func=Pin.types.INPUT,unit=1),
            Pin(num='28',name='STEP1',func=Pin.types.INPUT,unit=1),
            Pin(num='29',name='~{DRV_ENN}',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='CSN/IO0',func=Pin.types.BIDIR,unit=1),
            Pin(num='30',name='VSA',func=Pin.types.PWRIN,unit=1),
            Pin(num='31',name='GNDA',func=Pin.types.PWRIN,unit=1),
            Pin(num='32',name='5VOUT',func=Pin.types.PWROUT,unit=1),
            Pin(num='33',name='VCC',func=Pin.types.PWRIN,unit=1),
            Pin(num='34',name='GNDD',func=Pin.types.PASSIVE,unit=1),
            Pin(num='35',name='CPO',func=Pin.types.PASSIVE,unit=1),
            Pin(num='36',name='CPI',func=Pin.types.PASSIVE,unit=1),
            Pin(num='37',name='VCP',func=Pin.types.PASSIVE,unit=1),
            Pin(num='38',name='GNDD',func=Pin.types.PASSIVE,unit=1),
            Pin(num='39',name='O1B2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='4',name='SCK/IO1',func=Pin.types.BIDIR,unit=1),
            Pin(num='40',name='BR1B',func=Pin.types.PASSIVE,unit=1),
            Pin(num='41',name='O1B1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='42',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='43',name='GNDP',func=Pin.types.PASSIVE,unit=1),
            Pin(num='44',name='VS',func=Pin.types.PASSIVE,unit=1),
            Pin(num='45',name='O1A2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='46',name='BR1A',func=Pin.types.PASSIVE,unit=1),
            Pin(num='47',name='O1A1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='48',name='TST_MODE',func=Pin.types.INPUT,unit=1),
            Pin(num='49',name='GNDD',func=Pin.types.PASSIVE,unit=1),
            Pin(num='5',name='SDI/IO2',func=Pin.types.BIDIR,unit=1),
            Pin(num='6',name='GNDD',func=Pin.types.PWRIN,unit=1),
        ...
        Part(**{ 'name':'TMC2100-LA', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'TMC2100-LA'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:QFN-36-1EP_5x6mm_P0.5mm_EP3.6x4.1mm_ThermalVias'], 'footprint':'Package_DFN_QFN:QFN-36-1EP_5x6mm_P0.5mm_EP3.6x4.1mm_ThermalVias', 'keywords':'Driver stepper motor', 'description':'', 'datasheet':'https://www.trinamic.com/fileadmin/assets/Products/ICs_Documents/TMC2100_datasheet_Rev1.08.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nTMC2100-LA\n\nDriver stepper motor', 'pins':[
            ...
            Pin(num='13',name='OB1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='14',name='BRB',func=Pin.types.PASSIVE,unit=1),
            Pin(num='15',name='OB2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='16',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='17',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='18',name='CFG4',func=Pin.types.INPUT,unit=1),
            Pin(num='19',name='CFG5',func=Pin.types.INPUT,unit=1),
            Pin(num='2',name='CFG3',func=Pin.types.INPUT,unit=1),
            Pin(num='20',name='ERROR',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='21',name='INDEX',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='22',name='~{CFG6_ENN}',func=Pin.types.INPUT,unit=1),
            Pin(num='23',name='AIN_REF',func=Pin.types.INPUT,unit=1),
            Pin(num='24',name='GNDA',func=Pin.types.PWRIN,unit=1),
            Pin(num='25',name='5VOUT',func=Pin.types.PWROUT,unit=1),
            Pin(num='26',name='VCC',func=Pin.types.PWRIN,unit=1),
            Pin(num='27',name='CP0',func=Pin.types.PASSIVE,unit=1),
            Pin(num='28',name='CPI',func=Pin.types.PASSIVE,unit=1),
            Pin(num='29',name='VCP',func=Pin.types.PASSIVE,unit=1),
            Pin(num='3',name='CFG2',func=Pin.types.INPUT,unit=1),
            Pin(num='30',name='VSA',func=Pin.types.PWRIN,unit=1),
            Pin(num='31',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='32',name='OA2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='33',name='BRA',func=Pin.types.PASSIVE,unit=1),
            Pin(num='34',name='OA1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='35',name='GNDP',func=Pin.types.PASSIVE,unit=1),
            Pin(num='36',name='TST_MODE',func=Pin.types.INPUT,unit=1),
            Pin(num='37',name='GNDD',func=Pin.types.PASSIVE,unit=1),
            Pin(num='4',name='CFG1',func=Pin.types.INPUT,unit=1),
            Pin(num='5',name='CFG0',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='STEP',func=Pin.types.INPUT,unit=1),
        ...
        Part(**{ 'name':'TMC2100-TA', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'TMC2100-TA'}), 'ref_prefix':'U', 'fplist':['Package_QFP:TQFP-48-1EP_7x7mm_P0.5mm_EP5x5mm_ThermalVias'], 'footprint':'Package_QFP:TQFP-48-1EP_7x7mm_P0.5mm_EP5x5mm_ThermalVias', 'keywords':'Standalone driver stepper motor', 'description':'', 'datasheet':'https://www.trinamic.com/fileadmin/assets/Products/ICs_Documents/TMC2100_datasheet_Rev1.08.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nTMC2100-TA\n\nStandalone driver stepper motor', 'pins':[
            ...
            Pin(num='12',name='GNDD',func=Pin.types.PWRIN,unit=1),
            Pin(num='13',name='GNDP',func=Pin.types.PASSIVE,unit=1),
            Pin(num='14',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='15',name='OB1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='16',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='17',name='BRB',func=Pin.types.PASSIVE,unit=1),
            Pin(num='18',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='19',name='OB2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='2',name='CLK',func=Pin.types.INPUT,unit=1),
            Pin(num='20',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='21',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='22',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='23',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='24',name='CFG4',func=Pin.types.INPUT,unit=1),
            Pin(num='25',name='CFG5',func=Pin.types.INPUT,unit=1),
            Pin(num='26',name='ERROR',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='27',name='INDEX',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='28',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='29',name='~{CFG6_ENN}',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='CFG3',func=Pin.types.INPUT,unit=1),
            Pin(num='30',name='AIN_REF',func=Pin.types.INPUT,unit=1),
            Pin(num='31',name='GNDD',func=Pin.types.PASSIVE,unit=1),
            Pin(num='32',name='GNDA',func=Pin.types.PWRIN,unit=1),
            Pin(num='33',name='5VOUT',func=Pin.types.PWROUT,unit=1),
            Pin(num='34',name='VCC',func=Pin.types.PWRIN,unit=1),
            Pin(num='35',name='CP0',func=Pin.types.PASSIVE,unit=1),
            Pin(num='36',name='GNDD',func=Pin.types.PASSIVE,unit=1),
            Pin(num='37',name='CPI',func=Pin.types.PASSIVE,unit=1),
            Pin(num='38',name='VCP',func=Pin.types.PASSIVE,unit=1),
            Pin(num='39',name='VSA',func=Pin.types.PWRIN,unit=1),
            Pin(num='4',name='CFG2',func=Pin.types.INPUT,unit=1),
            Pin(num='40',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='41',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='42',name='OA2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='43',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='44',name='BRA',func=Pin.types.PASSIVE,unit=1),
            Pin(num='45',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='46',name='OA1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='47',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='48',name='GNDP',func=Pin.types.PWRIN,unit=1),
            Pin(num='49',name='GNDD',func=Pin.types.PASSIVE,unit=1),
            Pin(num='5',name='CFG1',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='GNDD',func=Pin.types.PASSIVE,unit=1),
        ...
        Part(**{ 'name':'TMC2130-LA', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'TMC2130-LA'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:QFN-36-1EP_5x6mm_P0.5mm_EP3.6x4.1mm'], 'footprint':'Package_DFN_QFN:QFN-36-1EP_5x6mm_P0.5mm_EP3.6x4.1mm', 'keywords':'stepper motor driver', 'description':'', 'datasheet':'http://www.trinamic.com/fileadmin/assets/Products/ICs_Documents/TMC2130_datasheet.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nTMC2130-LA\n\nstepper motor driver', 'pins':[
            ...
            Pin(num='15',name='OB2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='16',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='17',name='DCO',func=Pin.types.OUTPUT,unit=1),
            Pin(num='18',name='DCEN_CFG4',func=Pin.types.INPUT,unit=1),
            Pin(num='19',name='DCIN_CFG5',func=Pin.types.INPUT,unit=1),
            Pin(num='2',name='~{CS}_CFG3',func=Pin.types.INPUT,unit=1),
            Pin(num='20',name='DIAG0',func=Pin.types.OUTPUT,unit=1),
            Pin(num='21',name='DIAG1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='22',name='~{DRV_EN}_CFG6',func=Pin.types.INPUT,unit=1),
            Pin(num='23',name='AIN_IREF',func=Pin.types.INPUT,unit=1),
            Pin(num='24',name='GNDA',func=Pin.types.PWRIN,unit=1),
            Pin(num='25',name='5VOUT',func=Pin.types.PWROUT,unit=1),
            Pin(num='26',name='VCC',func=Pin.types.PWRIN,unit=1),
            Pin(num='27',name='CPO',func=Pin.types.PASSIVE,unit=1),
            Pin(num='28',name='CPI',func=Pin.types.PASSIVE,unit=1),
            Pin(num='29',name='VCP',func=Pin.types.PASSIVE,unit=1),
            Pin(num='3',name='SCK_CFG2',func=Pin.types.INPUT,unit=1),
            Pin(num='30',name='VSA',func=Pin.types.PWRIN,unit=1),
            Pin(num='31',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='32',name='OA2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='33',name='BRA',func=Pin.types.PASSIVE,unit=1),
            ...
            Pin(num='35',name='GNDP',func=Pin.types.PASSIVE,unit=1),
            Pin(num='36',name='TST_MODE',func=Pin.types.INPUT,unit=1),
            Pin(num='37',name='EP',func=Pin.types.PWRIN,unit=1),
            Pin(num='4',name='SDI_CFG1',func=Pin.types.INPUT,unit=1),
            Pin(num='5',name='SDO_CFG0',func=Pin.types.BIDIR,unit=1),
            Pin(num='6',name='STEP',func=Pin.types.INPUT,unit=1),
            Pin(num='7',name='DIR',func=Pin.types.INPUT,unit=1),
            Pin(num='8',name='VCC_IO',func=Pin.types.PWRIN,unit=1),
            Pin(num='9',name='DNC',func=Pin.types.NOCONNECT,unit=1)], 'unit_defs':[] }),
        Part(**{ 'name':'TMC2130-TA', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'TMC2130-TA'}), 'ref_prefix':'U', 'fplist':['Package_QFP:TQFP-48-1EP_7x7mm_P0.5mm_EP5x5mm'], 'footprint':'Package_QFP:TQFP-48-1EP_7x7mm_P0.5mm_EP5x5mm', 'keywords':'stepper motor driver', 'description':'', 'datasheet':'http://www.trinamic.com/fileadmin/assets/Products/ICs_Documents/TMC2130_datasheet.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nTMC2130-TA\n\nstepper motor driver', 'pins':[
            ...
            Pin(num='10',name='VCC_IO',func=Pin.types.PWRIN,unit=1),
            Pin(num='11',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='12',name='SPI_MODE',func=Pin.types.INPUT,unit=1),
            ...
            Pin(num='21',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='22',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='23',name='DCO',func=Pin.types.OUTPUT,unit=1),
            Pin(num='24',name='DCEN_CFG4',func=Pin.types.INPUT,unit=1),
            Pin(num='25',name='DCIN_CFG5',func=Pin.types.INPUT,unit=1),
            Pin(num='26',name='DIAG0',func=Pin.types.OUTPUT,unit=1),
            Pin(num='27',name='DIAG1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='28',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='29',name='~{DRV_EN}_CFG6',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='~{CS}_CFG3',func=Pin.types.INPUT,unit=1),
            Pin(num='30',name='AIN_IREF',func=Pin.types.INPUT,unit=1),
            Pin(num='31',name='NC',func=Pin.types.PASSIVE,unit=1),
            Pin(num='32',name='GNDA',func=Pin.types.PWRIN,unit=1),
            Pin(num='33',name='5VOUT',func=Pin.types.PWROUT,unit=1),
            Pin(num='34',name='VCC',func=Pin.types.PWRIN,unit=1),
            Pin(num='35',name='CPO',func=Pin.types.PASSIVE,unit=1),
            Pin(num='36',name='NC',func=Pin.types.PASSIVE,unit=1),
            Pin(num='37',name='CPI',func=Pin.types.PASSIVE,unit=1),
            Pin(num='38',name='VCP',func=Pin.types.PASSIVE,unit=1),
            Pin(num='39',name='VSA',func=Pin.types.PWRIN,unit=1),
            Pin(num='4',name='SCK_CFG2',func=Pin.types.INPUT,unit=1),
            Pin(num='40',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='41',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='42',name='OA2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='43',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            ...
            Pin(num='46',name='OA1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='47',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='48',name='GNDP',func=Pin.types.PASSIVE,unit=1),
            Pin(num='49',name='EP',func=Pin.types.PWRIN,unit=1),
            Pin(num='5',name='SDI_CFG1',func=Pin.types.INPUT,unit=1),
        ...
        Part(**{ 'name':'TMC2160', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'TMC2160'}), 'ref_prefix':'U', 'fplist':['Package_QFP:TQFP-48-1EP_7x7mm_P0.5mm_EP5x5mm'], 'footprint':'Package_QFP:TQFP-48-1EP_7x7mm_P0.5mm_EP5x5mm', 'keywords':'Standalone driver stepper motor', 'description':'', 'datasheet':'https://www.trinamic.com/fileadmin/assets/Products/ICs_Documents/TMC2160A-datasheet_Rev1.06.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nTMC2160\n\nStandalone driver stepper motor', 'pins':[
            ...
            Pin(num='13',name='~{CS}_CFG3',func=Pin.types.INPUT,unit=1),
            Pin(num='14',name='SCK_CFG2',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='SDI_CFG1',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='SDO_CFG0',func=Pin.types.PASSIVE,unit=1),
            Pin(num='17',name='STEP',func=Pin.types.INPUT,unit=1),
            Pin(num='18',name='DIR',func=Pin.types.INPUT,unit=1),
            Pin(num='19',name='GNDD',func=Pin.types.PWRIN,unit=1),
            Pin(num='2',name='CB1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='20',name='VCC_IO',func=Pin.types.PWRIN,unit=1),
            Pin(num='21',name='VCC_IO',func=Pin.types.PASSIVE,unit=1),
            Pin(num='22',name='SPI_MODE',func=Pin.types.INPUT,unit=1),
            Pin(num='23',name='DCEN_CFG4',func=Pin.types.INPUT,unit=1),
            Pin(num='24',name='DCIN_CFG5',func=Pin.types.INPUT,unit=1),
            Pin(num='25',name='DCO_CFG6',func=Pin.types.OUTPUT,unit=1),
            Pin(num='26',name='DIAG0',func=Pin.types.OUTPUT,unit=1),
            Pin(num='27',name='DIAG1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='28',name='~{DRV_EN}',func=Pin.types.INPUT,unit=1),
            Pin(num='29',name='VCC',func=Pin.types.PWRIN,unit=1),
            Pin(num='3',name='12VOUT',func=Pin.types.PWRIN,unit=1),
            Pin(num='30',name='GNDD',func=Pin.types.PASSIVE,unit=1),
            Pin(num='31',name='CPO',func=Pin.types.PASSIVE,unit=1),
            Pin(num='32',name='CPI',func=Pin.types.PASSIVE,unit=1),
            Pin(num='33',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='34',name='VCP',func=Pin.types.PASSIVE,unit=1),
            Pin(num='35',name='CA2',func=Pin.types.PASSIVE,unit=1),
            Pin(num='36',name='HA2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='37',name='BMA2',func=Pin.types.PASSIVE,unit=1),
            Pin(num='38',name='LA2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='39',name='LA1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='4',name='VSA',func=Pin.types.PWRIN,unit=1),
            Pin(num='40',name='BMA1',func=Pin.types.PASSIVE,unit=1),
            Pin(num='41',name='HA1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='42',name='CA1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='43',name='CB2',func=Pin.types.PASSIVE,unit=1),
            Pin(num='44',name='HB2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='45',name='BMB2',func=Pin.types.PASSIVE,unit=1),
            Pin(num='46',name='LB2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='47',name='LB1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='48',name='BMB1',func=Pin.types.PASSIVE,unit=1),
            Pin(num='49',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='5',name='5VOUT',func=Pin.types.PWROUT,unit=1),
            Pin(num='6',name='GNDA',func=Pin.types.PWRIN,unit=1),
        ...
        Part(**{ 'name':'TMC2202-WA', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'TMC2202-WA'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:TQFN-32-1EP_5x5mm_P0.5mm_EP3.4x3.4mm_ThermalVias'], 'footprint':'Package_DFN_QFN:TQFN-32-1EP_5x5mm_P0.5mm_EP3.4x3.4mm_ThermalVias', 'keywords':'Standalone driver stepper motor', 'description':'', 'datasheet':'https://www.analog.com/media/en/technical-documentation/data-sheets/TMC2202_TMC2208_TMC2224_datasheet_rev1.13.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nTMC2202-WA\n\nStandalone driver stepper motor', 'pins':[
            ...
            Pin(num='12',name='MS2',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='DIAG',func=Pin.types.OUTPUT,unit=1),
            Pin(num='14',name='CLK',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='PDN_UART',func=Pin.types.BIDIR,unit=1),
            Pin(num='16',name='VCC_IO',func=Pin.types.PWRIN,unit=1),
            Pin(num='17',name='STEP',func=Pin.types.INPUT,unit=1),
            Pin(num='18',name='VREF',func=Pin.types.INPUT,unit=1),
            Pin(num='19',name='GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='2',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='20',name='DIR',func=Pin.types.INPUT,unit=1),
            Pin(num='21',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='22',name='VS',func=Pin.types.PASSIVE,unit=1),
            Pin(num='23',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='24',name='OA2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='25',name='BRA',func=Pin.types.PASSIVE,unit=1),
            Pin(num='26',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='27',name='OA1',func=Pin.types.OUTPUT,unit=1),
            ...
            Pin(num='30',name='OB1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='31',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='32',name='BRB',func=Pin.types.PASSIVE,unit=1),
            Pin(num='4',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='5',name='ENN',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='GND',func=Pin.types.PWRIN,unit=1),
        ...
        Part(**{ 'name':'TMC2208-LA', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'TMC2208-LA'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:TQFN-32-1EP_5x5mm_P0.5mm_EP3.4x3.4mm_ThermalVias'], 'footprint':'Package_DFN_QFN:TQFN-32-1EP_5x5mm_P0.5mm_EP3.4x3.4mm_ThermalVias', 'keywords':'Standalone driver stepper motor', 'description':'', 'datasheet':'https://www.analog.com/media/en/technical-documentation/data-sheets/TMC2202_TMC2208_TMC2224_datasheet_rev1.13.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nTMC2208-LA\n\nStandalone driver stepper motor', 'pins':[
            ...
            Pin(num='12',name='INDEX',func=Pin.types.OUTPUT,unit=1),
            Pin(num='13',name='CLK',func=Pin.types.INPUT,unit=1),
            Pin(num='14',name='PDN_UART',func=Pin.types.BIDIR,unit=1),
            Pin(num='15',name='VCC_IO',func=Pin.types.PWRIN,unit=1),
            Pin(num='16',name='STEP',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='VREF',func=Pin.types.INPUT,unit=1),
            Pin(num='18',name='GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='19',name='DIR',func=Pin.types.INPUT,unit=1),
            Pin(num='2',name='ENN',func=Pin.types.INPUT,unit=1),
            Pin(num='20',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='21',name='OA2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='22',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='23',name='BRA',func=Pin.types.PASSIVE,unit=1),
            Pin(num='24',name='OA1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='25',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='26',name='OB1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='27',name='BRB',func=Pin.types.PASSIVE,unit=1),
            Pin(num='28',name='VS',func=Pin.types.PASSIVE,unit=1),
            Pin(num='3',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='4',name='CPO',func=Pin.types.PASSIVE,unit=1),
            Pin(num='5',name='CPI',func=Pin.types.PASSIVE,unit=1),
            Pin(num='6',name='VCP',func=Pin.types.PASSIVE,unit=1),
        ...
        Part(**{ 'name':'TMC2224-LA', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'TMC2224-LA'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:TQFN-32-1EP_5x5mm_P0.5mm_EP3.4x3.4mm_ThermalVias'], 'footprint':'Package_DFN_QFN:TQFN-32-1EP_5x5mm_P0.5mm_EP3.4x3.4mm_ThermalVias', 'keywords':'Standalone driver stepper motor', 'description':'', 'datasheet':'https://www.analog.com/media/en/technical-documentation/data-sheets/TMC2202_TMC2208_TMC2224_datasheet_rev1.13.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nTMC2224-LA\n\nStandalone driver stepper motor', 'pins':[
            ...
            Pin(num='12',name='BRB',func=Pin.types.PASSIVE,unit=1),
            Pin(num='13',name='OB2',func=Pin.types.OUTPUT,unit=1),
            ...
            Pin(num='19',name='VCC_IO',func=Pin.types.PWRIN,unit=1),
            Pin(num='2',name='INDEX',func=Pin.types.OUTPUT,unit=1),
            Pin(num='20',name='PDN_UART',func=Pin.types.BIDIR,unit=1),
            Pin(num='21',name='DIAG',func=Pin.types.OUTPUT,unit=1),
            Pin(num='22',name='SPREAD',func=Pin.types.INPUT,unit=1),
            Pin(num='23',name='DIR',func=Pin.types.INPUT,unit=1),
            Pin(num='24',name='ENN',func=Pin.types.INPUT,unit=1),
            Pin(num='25',name='STEP',func=Pin.types.INPUT,unit=1),
            Pin(num='26',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='27',name='CLK',func=Pin.types.INPUT,unit=1),
            Pin(num='28',name='MS1',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='4',name='CPO',func=Pin.types.PASSIVE,unit=1),
            Pin(num='5',name='CPI',func=Pin.types.PASSIVE,unit=1),
            Pin(num='6',name='VCP',func=Pin.types.PASSIVE,unit=1),
        ...
        Part(**{ 'name':'TMC2226-SA', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'TMC2226-SA'}), 'ref_prefix':'U', 'fplist':['Package_SO:HTSSOP-28-1EP_4.4x9.7mm_P0.65mm_EP2.75x6.2mm_ThermalVias'], 'footprint':'Package_SO:HTSSOP-28-1EP_4.4x9.7mm_P0.65mm_EP2.75x6.2mm_ThermalVias', 'keywords':'Standalone driver stepper motor', 'description':'', 'datasheet':'https://www.trinamic.com/fileadmin/assets/Products/ICs_Documents/TMC2226_datasheet_rev1.10.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nTMC2226-SA\n\nStandalone driver stepper motor', 'pins':[
            ...
            Pin(num='12',name='MS1_AD0',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='NC',func=Pin.types.PASSIVE,unit=1),
            Pin(num='14',name='MS2_AD1',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='DIAG',func=Pin.types.OUTPUT,unit=1),
            Pin(num='16',name='INDEX',func=Pin.types.OUTPUT,unit=1),
            Pin(num='17',name='CLK',func=Pin.types.INPUT,unit=1),
            Pin(num='18',name='PDN_UART',func=Pin.types.BIDIR,unit=1),
            Pin(num='19',name='VCC_IO',func=Pin.types.PWRIN,unit=1),
            Pin(num='2',name='BRB',func=Pin.types.PASSIVE,unit=1),
            Pin(num='20',name='STEP',func=Pin.types.INPUT,unit=1),
            Pin(num='21',name='VREF',func=Pin.types.PASSIVE,unit=1),
            Pin(num='22',name='GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='23',name='DIR',func=Pin.types.INPUT,unit=1),
            Pin(num='24',name='STDBY',func=Pin.types.INPUT,unit=1),
            Pin(num='25',name='OA2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='26',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='27',name='BRA',func=Pin.types.PASSIVE,unit=1),
            Pin(num='28',name='OA1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='29',name='GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='3',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='4',name='OB2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='5',name='~{EN}',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='GND',func=Pin.types.PWRIN,unit=1),
        ...
        Part(**{ 'name':'TMC262', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'TMC262'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:QFN-32-1EP_5x5mm_P0.5mm_EP3.45x3.45mm'], 'footprint':'Package_DFN_QFN:QFN-32-1EP_5x5mm_P0.5mm_EP3.45x3.45mm', 'keywords':'trinamic tlc262 stepper', 'description':'', 'datasheet':'https://www.trinamic.com/fileadmin/assets/Products/ICs_Documents/TMC262_Datasheet.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nTMC262\n\ntrinamic tlc262 stepper', 'pins':[
            ...
            Pin(num='13',name='GND',func=Pin.types.PWRIN,unit=1),
            Pin(num='14',name='CSN',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='~{ENN}',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='CLK',func=Pin.types.INPUT,unit=1),
            Pin(num='17',name='SRB',func=Pin.types.INPUT,unit=1),
            Pin(num='18',name='LB2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='19',name='LB1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='2',name='HA1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='20',name='BMB1',func=Pin.types.INPUT,unit=1),
            Pin(num='21',name='BMB2',func=Pin.types.INPUT,unit=1),
            Pin(num='22',name='HB2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='23',name='HB1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='24',name='VHS',func=Pin.types.PWRIN,unit=1),
            Pin(num='25',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='26',name='TST_ANA',func=Pin.types.OUTPUT,unit=1),
            Pin(num='27',name='SG_TST',func=Pin.types.OUTPUT,unit=1),
            Pin(num='28',name='GNDP',func=Pin.types.PWRIN,unit=1),
            Pin(num='29',name='VCC_IO',func=Pin.types.PWRIN,unit=1),
            Pin(num='3',name='HA2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='30',name='DIR',func=Pin.types.INPUT,unit=1),
            Pin(num='31',name='STEP',func=Pin.types.INPUT,unit=1),
            Pin(num='32',name='TST_MODE',func=Pin.types.INPUT,unit=1),
            Pin(num='33',name='DIE_PAD',func=Pin.types.INPUT,unit=1),
            Pin(num='4',name='BMA2',func=Pin.types.INPUT,unit=1),
            Pin(num='5',name='BMA1',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='LA1',func=Pin.types.OUTPUT,unit=1),
        ...
        Part(**{ 'name':'TMC2660', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'TMC2660'}), 'ref_prefix':'U', 'fplist':['Package_QFP:TQFP-44_10x10mm_P0.8mm'], 'footprint':'Package_QFP:TQFP-44_10x10mm_P0.8mm', 'keywords':'Standalone driver stepper motor', 'description':'', 'datasheet':'https://www.trinamic.com/fileadmin/assets/Products/ICs_Documents/TMC2660_datasheet_Rev1.07.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nTMC2660\n\nStandalone driver stepper motor', 'pins':[
            ...
            Pin(num='12',name='SRA',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='5VOUT',func=Pin.types.PWROUT,unit=1),
            Pin(num='14',name='SDO',func=Pin.types.PASSIVE,unit=1),
            ...
            Pin(num='19',name='~{EN}',func=Pin.types.INPUT,unit=1),
            Pin(num='2',name='OA1',func=Pin.types.PWROUT,unit=1),
            Pin(num='20',name='n.c.',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='21',name='CLK',func=Pin.types.INPUT,unit=1),
            Pin(num='22',name='SRB',func=Pin.types.INPUT,unit=1),
            Pin(num='23',name='OB2',func=Pin.types.PWROUT,unit=1),
            Pin(num='24',name='OB2',func=Pin.types.PASSIVE,unit=1),
            Pin(num='25',name='BRB',func=Pin.types.INPUT,unit=1),
            Pin(num='26',name='OB1',func=Pin.types.PWROUT,unit=1),
            Pin(num='27',name='OB1',func=Pin.types.PASSIVE,unit=1),
            Pin(num='28',name='OB2',func=Pin.types.PASSIVE,unit=1),
            Pin(num='29',name='OB2',func=Pin.types.PASSIVE,unit=1),
            Pin(num='3',name='OA1',func=Pin.types.PASSIVE,unit=1),
            Pin(num='30',name='VSB',func=Pin.types.PWRIN,unit=1),
            Pin(num='31',name='OB1',func=Pin.types.PASSIVE,unit=1),
            Pin(num='32',name='OB1',func=Pin.types.PASSIVE,unit=1),
            Pin(num='33',name='n.c.',func=Pin.types.FREE,unit=1),
            Pin(num='34',name='n.c.',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='35',name='VHS',func=Pin.types.PWRIN,unit=1),
            Pin(num='36',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='37',name='ST_ALONE/TST_ANA',func=Pin.types.INPUT,unit=1),
            Pin(num='38',name='SG_TST',func=Pin.types.OUTPUT,unit=1),
            Pin(num='39',name='GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='4',name='VSA',func=Pin.types.PWRIN,unit=1),
            Pin(num='40',name='VCC_IO',func=Pin.types.PWRIN,unit=1),
            Pin(num='41',name='DIR',func=Pin.types.INPUT,unit=1),
            Pin(num='42',name='STEP',func=Pin.types.INPUT,unit=1),
            Pin(num='43',name='TST_MODE',func=Pin.types.INPUT,unit=1),
            Pin(num='44',name='GND',func=Pin.types.PASSIVE,unit=1),
            Pin(num='5',name='OA2',func=Pin.types.PWROUT,unit=1),
            Pin(num='6',name='OA2',func=Pin.types.PASSIVE,unit=1),
        ...
        Part(**{ 'name':'TMC5130A-TA', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'TMC5130A-TA'}), 'ref_prefix':'U', 'fplist':['Package_QFP:TQFP-48-1EP_7x7mm_P0.5mm_EP5x5mm_ThermalVias'], 'footprint':'Package_QFP:TQFP-48-1EP_7x7mm_P0.5mm_EP5x5mm_ThermalVias', 'keywords':'Standalone driver stepper motor', 'description':'', 'datasheet':'https://www.trinamic.com/fileadmin/assets/Products/ICs_Documents/TMC5130_datasheet_Rev1.17.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nTMC5130A-TA\n\nStandalone driver stepper motor', 'pins':[
            ...
            Pin(num='21',name='VS',func=Pin.types.PWRIN,unit=1),
            Pin(num='22',name='DNC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='23',name='ENCN_DCO',func=Pin.types.BIDIR,unit=1),
            Pin(num='24',name='ENCB_DCEN_CFG4',func=Pin.types.INPUT,unit=1),
            Pin(num='25',name='ENCA_DCIN_CFG5',func=Pin.types.INPUT,unit=1),
            Pin(num='26',name='SWN_DIAG0',func=Pin.types.BIDIR,unit=1),
            Pin(num='27',name='SWP_DIAG1',func=Pin.types.BIDIR,unit=1),
            Pin(num='28',name='SWSEL',func=Pin.types.INPUT,unit=1),
            Pin(num='29',name='~{DRV_EN}_CFG6',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='~{CS}_CFG3',func=Pin.types.INPUT,unit=1),
            Pin(num='30',name='AIN_IREF',func=Pin.types.INPUT,unit=1),
            Pin(num='31',name='NC',func=Pin.types.PASSIVE,unit=1),
            ...
            Pin(num='48',name='GNDP',func=Pin.types.PASSIVE,unit=1),
            Pin(num='49',name='EP',func=Pin.types.PWRIN,unit=1),
            Pin(num='5',name='SDI_NAI_CFG1',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='NC',func=Pin.types.PASSIVE,unit=1),
        ...
        Part(**{ 'name':'TMC5160A-TA', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'TMC5160A-TA'}), 'ref_prefix':'U', 'fplist':['Package_QFP:TQFP-48-1EP_7x7mm_P0.5mm_EP5x5mm_ThermalVias'], 'footprint':'Package_QFP:TQFP-48-1EP_7x7mm_P0.5mm_EP5x5mm_ThermalVias', 'keywords':'stepper motor driver trinamic', 'description':'', 'datasheet':'https://www.trinamic.com/fileadmin/assets/Products/ICs_Documents/TMC5160A_Datasheet_Rev1.14.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nTMC5160A-TA\n\nstepper motor driver trinamic', 'pins':[
            ...
            Pin(num='11',name='TST_MODE',func=Pin.types.INPUT,unit=1),
            Pin(num='12',name='CLK',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='~{CS}/CFG3',func=Pin.types.INPUT,unit=1),
            Pin(num='14',name='SCK/CFG2',func=Pin.types.INPUT,unit=1),
            Pin(num='15',name='SDI/CFG1',func=Pin.types.INPUT,unit=1),
            Pin(num='16',name='SDO/CFG0',func=Pin.types.BIDIR,unit=1),
            Pin(num='17',name='REFL/STEP',func=Pin.types.INPUT,unit=1),
            Pin(num='18',name='REFR/DIR',func=Pin.types.INPUT,unit=1),
            Pin(num='19',name='GNDD',func=Pin.types.PWRIN,unit=1),
            Pin(num='2',name='CB1',func=Pin.types.PASSIVE,unit=1),
            Pin(num='20',name='VCC_IO',func=Pin.types.PWRIN,unit=1),
            Pin(num='21',name='SD_MODE',func=Pin.types.INPUT,unit=1),
            Pin(num='22',name='SPI_MODE',func=Pin.types.INPUT,unit=1),
            Pin(num='23',name='ENCB/DCEN/CFG4',func=Pin.types.INPUT,unit=1),
            Pin(num='24',name='ENCA/DCIN/CFG5',func=Pin.types.INPUT,unit=1),
            Pin(num='25',name='ENCN/DCO/CFG6',func=Pin.types.BIDIR,unit=1),
            Pin(num='26',name='SWN/DIAG0',func=Pin.types.BIDIR,unit=1),
            Pin(num='27',name='SWP/DIAG1',func=Pin.types.BIDIR,unit=1),
            Pin(num='28',name='~{DRV_EN}',func=Pin.types.INPUT,unit=1),
            Pin(num='29',name='VCC',func=Pin.types.PWRIN,unit=1),
            Pin(num='3',name='12VOUT',func=Pin.types.PWROUT,unit=1),
            Pin(num='30',name='GNDD',func=Pin.types.PASSIVE,unit=1),
            Pin(num='31',name='CPO',func=Pin.types.PASSIVE,unit=1),
            Pin(num='32',name='CPI',func=Pin.types.PASSIVE,unit=1),
            Pin(num='33',name='VS',func=Pin.types.PWRIN,unit=1),
            ...
            Pin(num='40',name='BMA1',func=Pin.types.PASSIVE,unit=1),
            Pin(num='41',name='HA1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='42',name='CA1',func=Pin.types.PASSIVE,unit=1),
            Pin(num='43',name='CB2',func=Pin.types.PASSIVE,unit=1),
            Pin(num='44',name='HB2',func=Pin.types.OUTPUT,unit=1),
            Pin(num='45',name='BMB2',func=Pin.types.PASSIVE,unit=1),
            Pin(num='46',name='LB2',func=Pin.types.OUTPUT,unit=1),
        ...
        Part(**{ 'name':'VNH2SP30', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'VNH2SP30'}), 'ref_prefix':'U', 'fplist':['Package_SO:ST_MultiPowerSO-30'], 'footprint':'Package_SO:ST_MultiPowerSO-30', 'keywords':'full-bridge h-bridge', 'description':'', 'datasheet':'http://www.st.com/content/ccc/resource/technical/document/datasheet/group2/66/b8/f5/2c/9a/66/41/c7/CD00043711/files/CD00043711.pdf/jcr:content/translations/en.CD00043711.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nVNH2SP30\n\nfull-bridge h-bridge', 'pins':[
            ...
            Pin(num='13',name='VCC',func=Pin.types.PASSIVE,unit=1),
            Pin(num='14',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='15',name='OUTB',func=Pin.types.OUTPUT,unit=1),
            Pin(num='16',name='OUTB',func=Pin.types.PASSIVE,unit=1),
            Pin(num='17',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='18',name='GNDB',func=Pin.types.PWRIN,unit=1),
            Pin(num='19',name='GNDB',func=Pin.types.PASSIVE,unit=1),
            Pin(num='2',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='20',name='GNDB',func=Pin.types.PASSIVE,unit=1),
            Pin(num='21',name='OUTB',func=Pin.types.PASSIVE,unit=1),
            Pin(num='22',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='23',name='VCC',func=Pin.types.PASSIVE,unit=1),
            Pin(num='24',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='25',name='OUTA',func=Pin.types.PASSIVE,unit=1),
            Pin(num='26',name='GNDA',func=Pin.types.PWRIN,unit=1),
            Pin(num='27',name='GNDA',func=Pin.types.PASSIVE,unit=1),
            Pin(num='28',name='GNDA',func=Pin.types.PASSIVE,unit=1),
            Pin(num='29',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='3',name='VCC',func=Pin.types.PWRIN,unit=1),
            Pin(num='30',name='OUTA',func=Pin.types.PASSIVE,unit=1),
            Pin(num='31',name='VCC',func=Pin.types.PASSIVE,unit=1),
            Pin(num='32',name='OUTB',func=Pin.types.PASSIVE,unit=1),
            Pin(num='33',name='OUTA',func=Pin.types.PASSIVE,unit=1),
            Pin(num='4',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='5',name='INA',func=Pin.types.INPUT,unit=1),
            Pin(num='6',name='EN/DIAA',func=Pin.types.OUTPUT,unit=1),
            Pin(num='7',name='NC',func=Pin.types.NOCONNECT,unit=1),
        ...
        Part(**{ 'name':'VNH5019A-E', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'VNH5019A-E'}), 'ref_prefix':'U', 'fplist':['Package_SO:ST_MultiPowerSO-30'], 'footprint':'Package_SO:ST_MultiPowerSO-30', 'keywords':'full-bridge h-bridge', 'description':'', 'datasheet':'https://www.st.com/resource/en/datasheet/vnh5019a-e.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nVNH5019A-E\n\nfull-bridge h-bridge', 'pins':[
            ...
            Pin(num='5',name='EN/DIAGA',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='6',name='CS_DIS',func=Pin.types.INPUT,unit=1),
        ...
        Part(**{ 'name':'ZXBM5210-S', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'ZXBM5210-S'}), 'ref_prefix':'U', 'fplist':['Package_SO:SOIC-8_3.9x4.9mm_P1.27mm'], 'footprint':'Package_SO:SOIC-8_3.9x4.9mm_P1.27mm', 'keywords':'H-bridge, motor driver, PWM, single coil', 'description':'', 'datasheet':'https://www.diodes.com/assets/Datasheets/ZXBM5210.pdf', 'search_text':'/usr/share/kicad/symbols/Driver_Motor.kicad_sym\nZXBM5210-S\n\nH-bridge, motor driver, PWM, single coil', 'pins':[
            ...
            Pin(num='4',name='FWD',func=Pin.types.INPUT),
            Pin(num='5',name='REV',func=Pin.types.INPUT),
