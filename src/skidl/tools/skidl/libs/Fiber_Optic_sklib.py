...
Fiber_Optic = SchLib(tool=SKIDL).add_parts(*[
        Part(**{ 'name':'AFBR-1624Z', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'AFBR-1624Z'}), 'ref_prefix':'J', 'fplist':[''], 'footprint':'', 'keywords':'Fiber optic transmitter', 'description':'', 'datasheet':'https://docs.broadcom.com/docs/AV02-4369EN', 'pins':[
        ...
        Part(**{ 'name':'AFBR-2624Z', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'AFBR-2624Z'}), 'ref_prefix':'J', 'fplist':[''], 'footprint':'', 'keywords':'fiber optic receiver', 'description':'', 'datasheet':'https://docs.broadcom.com/docs/AV02-4369EN', 'pins':[
