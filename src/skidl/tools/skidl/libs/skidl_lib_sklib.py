...
from skidl.tools.spice import add_part_to_circuit
...
skidl_lib = SchLib(tool=SKIDL).add_parts(*[
        Part(**{
            ...
            'pyspice':{
                ...
                '_aliases':Alias(['EXPONENTIALCURRENT', 'exponentialcurrent', 'expi']),
                'rise_time_constant':5,
                ...
                'fplist':None,
                'do_erc':True,
                'aliases':Alias({'EXPONENTIALCURRENT', 'exponentialcurrent', 'expi'}),
                'pin':None,
                'footprint':None,
                'pins':[
