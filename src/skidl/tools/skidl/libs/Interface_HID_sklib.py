...
Interface_HID = SchLib(tool=SKIDL).add_parts(*[
        Part(**{ 'name':'JoyWarrior24A10L', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'JoyWarrior24A10L'}), 'ref_prefix':'U', 'fplist':[''], 'footprint':'', 'keywords':'joystick controller 10bit 3-axis', 'description':'', 'datasheet':'http://codemercs.com/downloads/joywarrior/JW_Datasheet.pdf', 'search_text':'/usr/share/kicad/symbols/Interface_HID.kicad_sym\nJoyWarrior24A10L\n\njoystick controller 10bit 3-axis', 'pins':[
            ...
            Pin(num='12',name='Direct',func=Pin.types.INPUT,unit=1),
            ...
            Pin(num='17',name='Aux3',func=Pin.types.OUTPUT,unit=1),
            Pin(num='18',name='Aux1',func=Pin.types.OUTPUT,unit=1),
            Pin(num='19',name='Dout',func=Pin.types.OUTPUT,unit=1),
            Pin(num='2',name='X1/B1',func=Pin.types.INPUT,unit=1),
            Pin(num='20',name='SCLK',func=Pin.types.OUTPUT,unit=1),
            Pin(num='21',name='Y3/B7',func=Pin.types.INPUT,unit=1),
            Pin(num='22',name='Y2/B6',func=Pin.types.INPUT,unit=1),
            Pin(num='23',name='Y1/B5',func=Pin.types.INPUT,unit=1),
            Pin(num='24',name='Y0/B4',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='X2/B2',func=Pin.types.INPUT,unit=1),
            Pin(num='4',name='X3/B3',func=Pin.types.INPUT,unit=1),
            Pin(num='5',name='~{CS}',func=Pin.types.OUTPUT,unit=1),
        ...
        Part(**{ 'name':'SpinWarrior24A3', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'SpinWarrior24A3'}), 'ref_prefix':'U', 'fplist':[''], 'footprint':'', 'keywords':'16bit absolute position USB rotary encoder', 'description':'', 'datasheet':'http://www.codemercs.com/downloads/spinwarrior/SW_Datasheet.pdf', 'search_text':'/usr/share/kicad/symbols/Interface_HID.kicad_sym\nSpinWarrior24A3\n\n16bit absolute position USB rotary encoder', 'pins':[
            ...
            Pin(num='10',name='PullToGND',func=Pin.types.INPUT,unit=1),
            Pin(num='11',name='Vreg',func=Pin.types.PWROUT,unit=1),
            Pin(num='12',name='Power',func=Pin.types.INPUT,unit=1),
            Pin(num='13',name='NC',func=Pin.types.NOCONNECT,unit=1),
            Pin(num='14',name='Vcc',func=Pin.types.PWRIN,unit=1),
            Pin(num='15',name='D-',func=Pin.types.BIDIR,unit=1),
            Pin(num='16',name='D+',func=Pin.types.BIDIR,unit=1),
            Pin(num='17',name='~{EN}',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='18',name='In5',func=Pin.types.INPUT,unit=1),
            Pin(num='19',name='In3',func=Pin.types.INPUT,unit=1),
            Pin(num='2',name='B0',func=Pin.types.INPUT,unit=1),
            Pin(num='20',name='In1',func=Pin.types.INPUT,unit=1),
            Pin(num='21',name='N1',func=Pin.types.INPUT,unit=1),
            Pin(num='22',name='N0',func=Pin.types.INPUT,unit=1),
            Pin(num='23',name='B2',func=Pin.types.INPUT,unit=1),
            ...
            Pin(num='5',name='In0',func=Pin.types.INPUT,unit=1),
        ...
        Part(**{ 'name':'SpinWarrior24R4', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'SpinWarrior24R4'}), 'ref_prefix':'U', 'fplist':[''], 'footprint':'', 'keywords':'8bit relative position USB rotary encoder', 'description':'', 'datasheet':'http://www.codemercs.com/downloads/spinwarrior/SW_Datasheet.pdf', 'search_text':'/usr/share/kicad/symbols/Interface_HID.kicad_sym\nSpinWarrior24R4\n\n8bit relative position USB rotary encoder', 'pins':[
            ...
            Pin(num='16',name='D+',func=Pin.types.BIDIR,unit=1),
            Pin(num='17',name='~{EN}',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='18',name='Sw5',func=Pin.types.INPUT,unit=1),
            Pin(num='19',name='Sw3',func=Pin.types.INPUT,unit=1),
            Pin(num='2',name='B0',func=Pin.types.INPUT,unit=1),
            Pin(num='20',name='Sw1',func=Pin.types.INPUT,unit=1),
            Pin(num='21',name='B3',func=Pin.types.INPUT,unit=1),
            Pin(num='22',name='A3',func=Pin.types.INPUT,unit=1),
            Pin(num='23',name='B2',func=Pin.types.INPUT,unit=1),
            Pin(num='24',name='A2',func=Pin.types.INPUT,unit=1),
            Pin(num='3',name='A1',func=Pin.types.INPUT,unit=1),
            Pin(num='4',name='B1',func=Pin.types.INPUT,unit=1),
            Pin(num='5',name='Sw0',func=Pin.types.INPUT,unit=1),
        ...
        Part(**{ 'name':'SpinWarrior24R6', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'SpinWarrior24R6'}), 'ref_prefix':'U', 'fplist':[''], 'footprint':'', 'keywords':'8bit relative position USB rotary encoder', 'description':'', 'datasheet':'http://www.codemercs.com/downloads/spinwarrior/SW_Datasheet.pdf', 'search_text':'/usr/share/kicad/symbols/Interface_HID.kicad_sym\nSpinWarrior24R6\n\n8bit relative position USB rotary encoder', 'pins':[
            ...
            Pin(num='16',name='D+',func=Pin.types.BIDIR,unit=1),
            Pin(num='17',name='~{EN}',func=Pin.types.OPENCOLL,unit=1),
            Pin(num='18',name='A5',func=Pin.types.INPUT,unit=1),
            Pin(num='19',name='A4',func=Pin.types.INPUT,unit=1),
            Pin(num='2',name='B0',func=Pin.types.INPUT,unit=1),
            Pin(num='20',name='Sw1',func=Pin.types.INPUT,unit=1),
            Pin(num='21',name='B3',func=Pin.types.INPUT,unit=1),
            Pin(num='22',name='A3',func=Pin.types.INPUT,unit=1),
