...
MCU_WCH_CH32V2 = SchLib(tool=SKIDL).add_parts(*[
        ...
        Part(**{ 'name':'CH32V203GxUx', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'CH32V203GxUx'}), 'ref_prefix':'U', 'fplist':['Package_DFN_QFN:QFN-28-1EP_4x4mm_P0.4mm_EP2.8x2.8mm'], 'footprint':'Package_DFN_QFN:QFN-28-1EP_4x4mm_P0.4mm_EP2.8x2.8mm', 'keywords':'RISCV WCH MCU', 'description':'', 'datasheet':'https://www.wch-ic.com/downloads/CH32V203DS0_PDF.html', 'search_text':'/usr/share/kicad/symbols/MCU_WCH_CH32V2.kicad_sym\nCH32V203GxUx\n\nRISCV WCH MCU', 'pins':[
            Pin(num='1',name='BOOT0/PB8',func=Pin.types.BIDIR,unit=1),
            Pin(num='10',name='PA4',func=Pin.types.BIDIR,unit=1),
            Pin(num='11',name='PA5',func=Pin.types.BIDIR,unit=1),
            Pin(num='12',name='PA6',func=Pin.types.BIDIR,unit=1),
            Pin(num='13',name='PA7',func=Pin.types.BIDIR,unit=1),
            ...
            Pin(num='19',name='PA10/PA11/USB_D-',func=Pin.types.BIDIR,unit=1),
            Pin(num='2',name='OSC_IN/PD0',func=Pin.types.BIDIR,unit=1),
            Pin(num='20',name='PA12/USB_D+',func=Pin.types.BIDIR,unit=1),
            Pin(num='21',name='PA13/SWDIO',func=Pin.types.BIDIR,unit=1),
            Pin(num='22',name='PA14/SWCLK',func=Pin.types.BIDIR,unit=1),
            ...
            Pin(num='3',name='OSC_OUT/PD1',func=Pin.types.BIDIR,unit=1),
            Pin(num='4',name='~{RST}',func=Pin.types.INPUT,unit=1),
            Pin(num='5',name='VDDA',func=Pin.types.PWRIN,unit=1),
            Pin(num='6',name='PA0',func=Pin.types.BIDIR,unit=1),
            Pin(num='7',name='PA1',func=Pin.types.BIDIR,unit=1),
