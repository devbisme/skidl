...
# pip install ." in the RTD Advanced Settings.
...
project = "SKiDL"
copyright = f"2016-{datetime.now().year}, Dave Vandenbout"
...
# version = ""
version = pckg_info.__version__  # Comes from the installed package metadata
# The full version, including alpha/beta/rc tags.
# release = ""
release = pckg_info.__version__  # Comes from the installed package metadata
...
try:
    from skidl import __version__ as version
except ImportError:
    pass
else:
    release = version
...
latex_documents = [
    ("index", "user_guide.tex", "SKiDL Documentation", "devbisme", "manual")
]
