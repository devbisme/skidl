...
def esp32s3mini1(_p_3V3, _3v3_monitor, _5v_monitor, D_p, D_n, GND):
    ...
    C1 = Part(
        ...
        ref="C1",
        fields={
            "Sheetname": "esp32s3mini1",
            "Sheetfile": "esp32s3mini1.kicad_sch",
    ...
    U3 = Part(
        ...
        fields={
            "Sheetname": "esp32s3mini1",
            "Sheetfile": "esp32s3mini1.kicad_sch",
            "ki_keywords": "RF Radio BT ESP ESP32-S3 Espressif",
            "ki_fp_filters": "ESP32?S*MINI?1",
        },
    )
