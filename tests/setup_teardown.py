...
def setup_function(f):
    ...
    lib_search_paths.update({KICAD: [os.getcwd(), this_file_dir, get_filename("../skidl/libs")]})
    # lib_search_paths.update({KICAD_V6: [os.getcwd(), this_file_dir, get_filename("../skidl/libs")]})
