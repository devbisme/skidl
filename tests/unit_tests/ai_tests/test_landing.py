...
class TestBasicUsage:
    ...
    def test_voltage_divider_circuit(self):
        ...
        r1, r2 = 2 * Part(
            "Device", "R", TEMPLATE, footprint="Resistor_SMD.pretty:R_0805_2012Metric"
        )
    ...
    def test_pin_connections(self):
        ...
        rup = Part(
            "Device", "R", value="1K", footprint="Resistor_SMD.pretty:R_0805_2012Metric"
        )
        rlow = Part(
            "Device",
            "R",
...
class TestHierarchy:
    ...
    def test_context_based_hierarchy(self):
        ...
        assert {child.name for child in default_circuit.root.children} == {
            "power_supply1",
            "microcontroller1",
        }
...
class TestPartClasses:
    ...
    def test_individual_part_classes(self):
        ...
        resistor = Part(
            "Device", "R", value="1K", partclasses=(passive_parts, commercial)
        )
    ...
    def test_individual_net_classes(self):
        ...
        # Create net classes
        high_speed = NetClass(
            "high_speed", priority=2, width="0.1mm", impedance="50ohm"
        )
        power_nets = NetClass(
            "power_nets", priority=4, width="0.5mm", clearance="0.3mm"
        )
