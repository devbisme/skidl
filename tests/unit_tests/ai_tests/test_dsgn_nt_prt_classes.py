...
from skidl.design_class import (
    NetClass,
    PartClass,
    NetClasses,
    PartClasses,
...
class TestPartClass:
    ...
    def test_partclass_hash(self):
        ...
        pc2 = PartClass(
            "TestClass", priority=5, circuit=circuit
...
class TestNetClass:
    ...
    def test_netclass_differential_pairs(self):
        ...
        circuit = Circuit()
        nc = NetClass(
            "DiffPairClass", diff_pair_width=0.1, diff_pair_gap=0.2, circuit=circuit
        )
...
class TestCircuitIntegration:
    ...
    def test_multiple_netclasses_per_net(self):
        ...
        # Create net classes
        high_current = NetClass(
            "HighCurrent", priority=1, trace_width=0.5, circuit=circuit
        )
