...
intfc_brd_lib = SchLib(tool=SKIDL).add_parts(*[
        ...
        Part(name='LED',dest=TEMPLATE,tool=SKIDL,description='LED generic',keywords='led diode',ref_prefix='D',num_units=1,fplist=['LED*'],do_erc=True,footprint='Diodes_SMD:D_0603',pins=[
